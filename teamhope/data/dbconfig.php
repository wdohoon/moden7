...
define('G5_MYSQL_HOST', 'db.moden2411.gabia.io');
define('G5_MYSQL_USER', 'moden2411');
define('G5_MYSQL_PASSWORD', '2580ac2580!');
define('G5_MYSQL_DB', 'dbmoden2411');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '0027398e7a4454c25e4bb4f1d690d5a1'); // 토큰 암호화에 사용할 키

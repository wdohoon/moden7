...
<!-- 게시물 읽기 시작 { -->
<style type="text/css">
#bo_v_info table {max-width:660px;}
.write_head { width:50%;height:47px;text-align:center; color:#000000; font-size:16px; font-weight:bold; background-color: #f9f9f9; border-right:1px solid #d7d7d7;border-left:1px solid #d7d7d7; border-bottom:1px solid #d7d7d7; }
...
.write_body2 { background-color: #ffffff; width:50%; padding:11px 0 11px 20px; border-right:1px solid #d7d7d7; border-bottom:1px solid #d7d7d7; font-size:16px}
...
#bo_v{ background:#fff; padding-top: 300px;}
#bo_v table{margin:0 auto;display: flex;}
#bo_v_con{max-width: 660px;	margin:0 auto;}
#container_title{
	display: none;
}
header {
...
<article id="bo_v" style="width:<?php echo $width; ?>">
	...
	<table border="0" cellpadding="0" cellspacing="0" >
		...
		<td class="write_head" colspan='4' style="text-align:center; width:1500px;"><?php
		            // 분류 출력 끝
		            echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력
		            ?></td>

...
<style>
	...
	.artists_img{margin:0 auto;width: 90%;}
	.artists_img img{width: 100%;}
	...
	.artists{display: flex; gap:40px;flex-wrap:wrap;padding-bottom:200px;}
	.content_img{display: flex;justify-content:center;}
	    .contents a {
        color: black; /* 링크 색상 */
  ...
  <div class="swiper_wraps">
    <div class="swiper-container mySwiper">
      <div class="swiper-wrapper">
        ...
        <!-- <div class="swiper-slide"><img src="/images/byun2_m.jpg" alt=""></div> -->
        <div class="swiper-slide"><img src="/images/byun3_m.jpg" alt=""></div>
...
<div id="main_wrap">
	...
	<div class="title_wrap">
		<div class="tit">
			<h1 style="font-size:40px;">TEAMHOPE</h1>
		</div>
		<div class="sub_tit">
			<h4>TEAMHOPE는 희망을 꿈꾸는 사람들이 함께 합니다.</h4>
			<span>보이지 않는 것들은 희망으로 볼 수 있도록,<br> 그리고 보이는 것들은 희망으로 이끌 수 있도록, <br>열의와 담대함으로 매순간 성장하는 <br><strong>TEAMHOPE</strong>와 함께해주세요.</span>
		</div>
	</div>

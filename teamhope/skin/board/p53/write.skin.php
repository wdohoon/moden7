...
$wr_content = nl2br(stripslashes($wr_content));
?>
<style>
	#bo_w{
		width: 1400px;
...
<section id="bo_w" style="font-size:15px">
...
<!-- 	<div style="font-size: 14px;">
	        <label for="wr_1">※ 동영상을 유튜브 동영상으로 첨부할 경우 입력하세요.</label><br>
...
<!-- <?php for ($i=1; $is_link && $i<=G5_LINK_COUNT; $i++) { ?>
    ...
    <div class="bo_w_flie write_div" id="mar">
        <div class="file_wr write_div">
			...
			<p style="margin-top:20px;font-size:15px;color:#f00">* 첫번째 파일에 목록 썸네일에 나타낼 사진을 넣어주세요.</p>
        </div>
	...
	<style type="text/css">
	#bo_w .btn_confirm {margin-bottom:100px;}
	.btn_confirm .btn_cancel {background:#333;width:70px;font-size:14px;}
	.btn_confirm .btn_submit {background:#333;font-size:14px;}
	
	</style>
    <div class="btn_confirm write_div">
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_cancel btn">취소</a>
        <input type="submit" value="글쓰기" id="btn_submit" accesskey="s" class="btn_submit btn">
    </div>
    </form>

...
.gall_chk {z-index:50;}
#fboardlist {border-top:1px solid #fff;}

.board_texts {position:relative;width:920px;padding-left: 35px;}
.board_texts p {text-align:left;width:100%;}

.board_title_txt {font-size: 22px;color:#000;margin:35px 0 35px 0;width:100%;overflow:hidden;white-space: nowrap;text-overflow: ellipsis;}
.board_content {font-size: 16px;color:#000;line-height:2;}
.board_content > img {display:none;}
#bo_gall .gall_img {    display: flex;
    flex-direction: column;
    align-items: center;}
.gall_con {padding:0 0 20px;width: 1280px;position:relative; display: flex;justify-content:center;}
...
#bo_gall .gall_img .right_img img{
	position:absolute;
	right:0;
	top:50%;
	width: 15px;
...
.black-text:hover {
    color: #000; /* 마우스 오버시에도 검정색 유지 */
    text-decoration: underline; /* 마우스 오버시 밑줄 표시 */
}
.gall_img_wrap{display: flex;align-items:center;justify-content:center;width: 30%;}
.gall_img_wrap img{width: 100%;}
</style>
                ...
                <div class="gall_con">
                    <div class="gall_img">
                        ...
                        <div class="board_texts">
							<!-- <div class="right_img">
								<a href="<?php echo $list[$i]['href'] ?>">	<img src="/images/right.png" alt=""></a>
							</div> -->
							<a href="<?php echo $list[$i]['href'] ?>">							

...
#bo_v{padding-top: 280px; width: 1280px; margin: 0 auto;}
...
.names{margin: 110px 0 0 80px; display: flex;gap:20px;padding-bottom:20px;border-bottom:solid 1px #ccc;width: 100%;align-items: flex-end;font-size:18px;position: relative;}
.names h4{font-size: 28px;}
.names span{color:#000;}
.names .sns{position:absolute;right:0;}
#bo_v_act{width: 580px;margin-bottom: 180px;}
.info_wrap{margin: 40px 0 0 80px;gap: 20px;display: flex; flex-direction: column;}
.info{display: flex;font-size: 16px; gap:20px;}
.info h4{width: 60px;text-align:left;}
.info span{color: #000;}
.movie_wrap{margin: 50px 0 0 80px;display: flex; flex-direction: column; width: 1000px;}
.movie h3{text-align:left; margin-bottom: 20px;font-size:20px;}
.swiper-horizontal{width: 800px;height: 100%;}
...
.info span{line-height:1.5; font-family: 'Noto Sans KR', sans-serif;font-size: 16px;}
...
<div class="movie_wrap">
    ...
    <div class="info">
        <h4><?php echo $view['wr_43'] ?></h4><span><?php echo $view['wr_44'] ?></span>
    </div>
    <?php endif; ?>

    <?php if (!empty($view['wr_45']) && !empty($view['wr_46'])): ?>
    <div class="info">
        <h4><?php echo $view['wr_45'] ?></h4><span><?php echo $view['wr_46'] ?></span>
    </div>
    <?php endif; ?>

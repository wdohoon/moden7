                ...
                <div class="gall_con">
                    <div class="gall_img">
						...
						echo $img_content;
                         ...
                         ?>
						 <div class="gall_on">
							<p class="p1"><?php //echo $board['bo_subject'] ?>TV-CF</p>
							<p class="p2"><?php echo $list[$i]['subject'] ?></p>
						 </div>
                        </a>
                    </div>
...
$(function(){
	$(".gall_img").mouseenter(function(){
		$(this).find(".gall_on").fadeIn();
	});
	$(".gall_img").mouseleave(function(){
		$(this).find(".gall_on").stop().fadeOut();
	});
})
</script>

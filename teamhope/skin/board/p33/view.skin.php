...
<article id="bo_v" style="margin-top:200px;width:<?php echo $width; ?>;">
    <header>
        <h2 id="bo_v_title">
			...
			<?php echo " (".substr($view['wr_1'],4,2)."/".substr($view['wr_1'],6,2)." ~ ".substr($view['wr_2'],4,2)."/".substr($view['wr_2'],6,2).")";?>
			</span>
        </h2>
    </header>
        ...
        for ($i=0; $i<count($view['file']); $i++) {
         ...
         ?>
            <li>
                ...
                <span class="bo_v_file_cnt" style="display:none;"><?php echo $view['file'][$i]['download'] ?>회 다운로드 | DATE : <?php echo $view['file'][$i]['datetime'] ?></span>
            </li>
        <?php
            }
        }

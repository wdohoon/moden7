...
define('G5_MYSQL_HOST', 'db.moden2403.gabia.io');
define('G5_MYSQL_USER', 'moden2403');
define('G5_MYSQL_PASSWORD', '2580ac2580!');
define('G5_MYSQL_DB', 'dbmoden2403');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '484546746ed4cc04ee26cfff876f45ab'); // 토큰 암호화에 사용할 키

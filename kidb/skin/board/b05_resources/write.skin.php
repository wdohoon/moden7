...
<style>
	...
	.who_bg .who_box span{
		<?php
		if ($bo_table == 'archive') {
			echo "font-size: 44px !important";
		} else {
			echo "font-size: 25px !important";
		}
		?>
	}
...
<section id="bo_w" style="background:#fff;">
  ...
  <!--       <tr>
       ...
       <!--  <tr>
		...
		<tr>
            <th scope="row"><label for="wr_3">작성일</label></th>
            <td><input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3"></td>
        </tr>

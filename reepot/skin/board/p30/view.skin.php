...
#bo_v{width:1200px;margin:100px auto}
</style>
...
<article id="bo_v" >
	...
	<tr>
		<td class="write_head" style="border-left:1px solid #dbdbdb;">지점명</td>
		<td class="write_body"><?php echo $view['wr_3'] ?></td>
		<td class="write_head">연락처</td>
		<td class="write_body2"><?php echo $view['wr_7'] ?></td>
	</tr>

	<tr>
		<td class="write_head" style="border-left:1px solid #dbdbdb;">매장주소</td>
		<td class="write_body" colspan="3"><?php echo $view['wr_4'] ?></td>
    ...
    <section id="bo_v_atc">
		...
		<!-- <div id="bo_v_map" style="margin: 20px 0;">
			<h3 style="font-size: 14px;color: #333;margin-bottom: 10px;"><i class="fa fa-map-marker" aria-hidden="true"></i> 매장위치</h3>
...
<script>
var pos_lat = <?php echo $view['wr_5'] ?>;
var pos_lng = <?php echo $view['wr_6'] ?>;
var title = "<?php echo $view['wr_3'] ?>";
var address = "<?php echo $view['wr_4'] ?>";
var tel = "<?php echo $view['wr_7'] ?>";

function initMap() {
	var myLatLng = {lat: pos_lat, lng: pos_lng};
	...
	var contentString = '<div id="content" style="line-height:1.7em">'+

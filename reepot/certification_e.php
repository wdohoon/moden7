...
if(defined('G5_THEME_PATH')) {
    require_once(G5_THEME_PATH.'/certification_e.php');
    return;
}

if (G5_IS_MOBILE) {
    include_once(G5_MOBILE_PATH.'/certification_e.php');
    return;
}
...
.sc_01 .sc_inner{min-height: 60vw;display: flex;flex-direction: column;justify-content: flex-end;align-items: center;}
...
.sc_06 .sc_inner .elementore-description{font-size: 1.5vw;font-weight: 400;line-height: 1.5em;letter-spacing: 0px;text-align:center}
...
.sc_07 .swiper-slide .slide-box dd{font-size: 1.2vw;font-weight: 400;line-height: 1.5em;letter-spacing: 0px;}
...
.sc_09 .sc_inner .elementore-heading{font-size: 3.04vw;}
...
.sc_01 .sc-txt .elementore-description {font-size: 1.7vw;}
.sc_06 .sc_inner .elementore-description {font-size: 1.7vw;}
...
.sc_09 .sc_inner .elementore-description { font-size: 1.7vw;}
...
.sc_09 .sc_inner .elementore-heading { margin-top: 23.61vw;}
...
.sc_09 .sc_inner .elementore-heading {font-size: 7.04vw;}
...
<div class="certification">
  ...
  <div class="sc_01">
    <div class="sc_inner">
      <div class="box">
        <div class="sc-txt">
          <h2 class="elementore-heading ">Certification</h2>
			<div class="elementore-description">
				<!-- Verify the use of reepot genuine <br class="m-only">treatment tips using the QR code. -->
				Make sure you are using certified<br class="m-only"> reepot treatment tips<br class="m-only"> by scanning the QR code.
			</div>
        </div>
      </div>
    </div>
  ...
  <div class="sc_02 sc_pe">
    <div class="sc_inner">
      <div class="box">
        <div class="sc-txt">
          <h2 class="elementore-heading "><span style="font-weight:600;">Safe</span><br class="m-none">and Healthily</h2>
        </div>
      </div>
    </div>
  </div>
 ...
 <div class="sc_03 sc_pe">
    <div class="sc_inner">
      <div class="box">
        <div class="sc-txt">
          <h2 class="elementore-heading right"><span style="font-weight:600;">Reliable and trustworthy</span><br class="">Anywhere in the world</h2>
        </div>
      </div>
    </div>
  </div>
   ...
   <div class="sc_04 sc_pe">
    <div class="sc_inner">
      <div class="box">
        <div class="sc-txt">
          <h2 class="elementore-heading "><span style="font-weight:600;">A treatment tip</span><br class="">Just for me</h2>
        </div>
      </div>
    </div>
  </div>
   ...
   <div class="sc_05 sc_pe">
    <div class="sc_inner">
      <div class="box">
        <div class="sc-txt">
			<h2 class="elementore-heading right">
				<span style="font-weight:600;">
					Make sure <br class="m-only">you are using
				</span><br>
				Certified reepot<br class="m-only"> treatment tips
			</h2>
        </div>
      </div>
    </div>
 ...
 <div class="sc_06">
    <div class="sc_inner">
      <div class="box">
        <div class="sc-txt">
          <h2 class="elementore-heading">Each certified <br class="m-only">reepot treatment tip<span style="font-size:2vw;"></span></h2>
          <p class="elementore-description"> comes with a unique reepot certification<br class="m-only"> QR code attached.</p>
        </div>
      </div>
    </div>
  </div>
         ...
         <div class="swiper-wrapper">
           <div class="swiper-slide">
             <div class="slide-box box01">
               <dl>
               <dt>STEP 01</dt>
               <dd>Remove the certification sticker attached<br> to the  product and scan the QR code. </dd>
               </dl>
             </div>
           </div>
           <div class="swiper-slide ">
             <div class="slide-box box02">
               <dl>
               <dt>STEP 02</dt>
               <dd>Click on the link to access the page, <br>then press the certification icon. </dd>
               </dl>
             </div>
           </div>
           <div class="swiper-slide">
             <div class="slide-box box03">
               ...
               <dt>STEP 03</dt>
               <dd>
					When the screen for entering the certificationbr	<br>
					code appears, carefully enter the serial number <br>
					displayed on the sticker.</dd>
               </dl>
             </div>
           </div>
           <div class="swiper-slide">
             <div class="slide-box box04">
               <dl>
               <dt>STEP 04 </dt>
               <dd>Check that certification was successful <br> on the following screen. </dd>
               </dl>
             </div>
           </div>
         </div>
 ...
 <div class="sc_08">
    <div class="sc_inner">
      <div class="box">
        <div class="sc-txt">
          <h2 class="elementore-heading">Enjoy a whole new world after certification</h2>
          <p class="elementore-description">Check out <br>an array of reepot content</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="sc_09">
    <div class="sc_inner">
      <div class="box">
        <div class="sc-txt">
          <h2 class="elementore-heading">reepot Concierge Center</h2>
          <div class="elementore-description">
            <ul>
              <li>SOS for urgent requests: sales@ilooda.com</li>
              <li>Weekdays 09:00 – 18:00</li>
              <li>Closed on weekends and public holidays</li>
            </ul>
          </div>
          <div class="go">
            <a href="https://eng.ilooda.com/contact/">Submit an inquiry<img src="/images/arrow-right-b.png" alt=""></a>
          </div>
        </div>
      </div>
    </div>

							...
							<div class="minframe">
								<div class="gn-brand-box">
									...
									<ul class="row">
										...
										<li class="col-4 col-sm-6">
											<a href="https://www.ilooda.com/brand/hyzerme.php" target="_blank" class="gnb-link" style="background-image:url(/assets/img/brand/hyzer-me.png)">
												<span>
								...
								<div class="gn-brand-box">
									...
									<ul class="row">
										<li class="col-4 col-sm-6">
											<a href="/brand/cure-j.php" class="gnb-link" style="background-image:url(/assets/img/brand/cure-j.png)">
												<span>Cure.J</span>
												<span class="__hover"><img src="/assets/img/i/add-round.png" alt=""></span>
											</a>
										</li>
										<li class="col-4 col-sm-6">
											<a href="/brand/acutron.php" class="gnb-link" style="background-image:url(/assets/img/brand/acutron.png?ver=2)">
												<span>
													<img src="/assets/img/aesthetic/acutron.svg" alt="acutron" class="acutron">
												</span>
												<span class="__hover"><img src="/assets/img/i/add-round.png" alt=""></span>
											</a>
										</li>

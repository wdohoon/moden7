    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide swiper-slide01">
        ...
        <a class="swiper-slide-inner" href="/brand_e.php">
          <div class="elementor-slide-heading">Can you picture yourself here?<br>Your very own Querencia</div>
      ...
      <div class="swiper-slide swiper-slide02">
        ...
        <div class="elementor-slide-description">
			...
			Experience the healthy energy to look after yourself and live your best life in reepot’s Querencia.
		</div>
         </a>
        </div>
      </div>
      ...
      <div class="swiper-slide swiper-slide01">
        ...
        <a class="swiper-slide-inner " href="/technolog_e.php">
          <div class="elementor-slide-heading ">
			...
			Experience intense cooling <br>and the smoothness of sapphire
		  </div>

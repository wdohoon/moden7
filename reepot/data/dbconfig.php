...
define('G5_MYSQL_HOST', 'db.reepotlaser.gabia.io');
define('G5_MYSQL_USER', 'reepotlaser');
define('G5_MYSQL_PASSWORD', '2580ac2580!');
define('G5_MYSQL_DB', 'dbreepotlaser');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', 'bca25694d8ff648df5ef9175887c417b'); // 토큰 암호화에 사용할 키

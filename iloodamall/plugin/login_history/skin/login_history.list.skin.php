...
<form id="fsearch" name="fsearch" class="local_sch01 local_sch" method="get">
	...
	<select name="sfl" id="sfl">
		...
		<option value="user_name" <?php echo get_selected($sfl, "user_name"); ?>>이름</option>
		<option value="history_datetime" <?php echo get_selected($sfl, "history_datetime"); ?>>날짜</option>
		<option value="read" <?php echo get_selected($sfl, "read"); ?>>읽기</option>
		<option value="create" <?php echo get_selected($sfl, "create"); ?>>추가</option>
		<option value="update" <?php echo get_selected($sfl, "update"); ?>>변경</option>
		<option value="delete" <?php echo get_selected($sfl, "delete"); ?>>삭제</option>
	</select>
...
<div class="tbl_head01 tbl_wrap">
    <table>
		...
		<?php ?>
            <tr>
                <td><?php echo $row['accessed_page']; ?></td>

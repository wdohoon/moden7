        ...
        <table>
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col" class="none"><?php echo subject_sort_link('bo_skin', '', 'desc') ?>스킨</a></th>
                    <th scope="col" class="none"><?php echo subject_sort_link('bo_mobile_skin', '', 'desc') ?>모바일<br>스킨</a></th>
                    <th scope="col"><?php echo subject_sort_link('bo_subject') ?>제목</a></th>
                    <th scope="col" class="none">읽기P<span class="sound_only">포인트</span></th>
                    <th scope="col" class="none">쓰기P<span class="sound_only">포인트</span></th>
                    <th scope="col" class="none">댓글P<span class="sound_only">포인트</span></th>
                    <th scope="col" class="none">다운P<span class="sound_only">포인트</span></th>
                    <th scope="col" class="none"><?php echo subject_sort_link('bo_use_sns') ?>SNS<br>사용</a></th>
                    <th scope="col" class="none"><?php echo subject_sort_link('bo_use_search') ?>검색<br>사용</a></th>
                    <th scope="col" class="none"><?php echo subject_sort_link('bo_order') ?>출력<br>순서</a></th>
                    <th scope="col" class="none">접속기기</th>
                    <th scope="col">관리</th>
                </tr>
            </thead>
            <tbody>

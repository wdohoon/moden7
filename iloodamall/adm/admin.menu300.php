...
if($mb_id == 'log_admin'){
	$menu['menu300'] = array(
		...
		//array('300110', '정품등록관리', '' . get_pretty_url('genuine') , 'bbs_board'),
		//array('300110', '정품등록관리', '' . get_pretty_url('genuine') , 'bbs_board'),
		//array('300120', '가디언즈 관리', '' . G5_ADMIN_URL . '/guardians.php', 'bbs_board'),
		//array('300130', '제품신청목록', '' . get_pretty_url('product_application') , 'bbs_board'),
		//array('300140', '가디언즈신청목록', '' . get_pretty_url('guardians') , 'bbs_board'),

    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
				<?php
				// 허용된 메뉴 코드 목록
				$allowed_menus = ['200100', '200200', '200210', '200710', '300110', '300120', '300130', '300140', '300100', '300200', '400100', '400400', '400200', '400300', '400660', '400800', '400900', '500110', '500120'];
				?>

				<select id='pre-selected-options' multiple='multiple' name="au_menu[]">
					<?php
					foreach($auth_menu as $key => $value) {
						if (in_array($key, $allowed_menus)) {
							echo '<option value="'.$key.'">'.$key.' '.$value.'</option>';
						}
					}
					?>
				</select>
				<link rel="stylesheet" type="text/css" href="<?php echo G5_CSS_URL?>/multi-select.css">
				<script src="<?php echo G5_JS_URL?>/jquery.multi-select.js"></script>
				<script type="text/javascript">
					// run pre selected options
					$('#pre-selected-options').multiSelect({
						selectableHeader: "<div class='custom-header'>권한을 선택하세요.</div>",
						selectionHeader: "<div class='custom-header'>선택된 권한</div>",
					});
				</script>
            </td>
        </tr>
...
<script>
    ...
    $("#mb_id").autocomplete({                    
        ...
        source: function(request, response) {
            $.ajax({
                url: "<?php echo G5_ADMIN_URL?>/ajax.member_chk.php?term="+$("#mb_id").val(),
                type: "GET",
                dataType: "json",

...
if (!isset($config['cf_member_img_size'])) {
    ...
    $sql = " update {$g5['config_table']} set cf_member_img_size = 41943040, cf_member_img_width = 2000, cf_member_img_height = 20000 ";
    sql_query($sql, false);

    $config['cf_member_img_size'] = 41943040;
    $config['cf_member_img_width'] = 2000;
    $config['cf_member_img_height'] = 20000;
}
            ...
            <table>
                ...
                <tbody>
					...
					<tr>
                        ...
                        <td colspan="3"><input type="checkbox" name="cf_use_money" value="1" id="cf_use_point" <?php echo $config['cf_use_money'] ? 'checked' : ''; ?>> 사용</td>
                    </tr>
                    <tr>
					...
					<tr>
                        <th scope="row"><label for="cf_money_term">적립금 유효기간</label></th>
                        <td colspan="3">
                            <?php echo help('기간을 0으로 설정시 적립금 유효기간이 적용되지 않습니다.') ?>
                            <input type="text" name="cf_money_term" value="<?php echo (int) $config['cf_money_term']; ?>" id="cf_point_term" required class="required frm_input" size="5"> 일
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"><label for="cf_register_money">회원가입시 적립금</label></th>
                        <td><input type="text" name="cf_register_money" value="<?php echo (int) $config['cf_register_money'] ?>" id="cf_register_point" class="frm_input" size="5"> 원</td>
						<th scope="row" style="display: none;"><label for="cf_register_point">회원가입시 포인트</label></th>
						<td style="display: none;"><input type="text" name="cf_register_point" value="<?php echo (int) $config['cf_register_point'] ?>" id="cf_register_point" class="frm_input" size="5"> 점</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th scope="row"><label for="cf_recommend_money">추천인 적립금</label></th>
                        <td><input type="text" name="cf_recommend_money" value="<?php echo (int) $config['cf_recommend_money'] ?>" id="cf_recommend_point" class="frm_input"> 원</td>
						<th scope="row" style="display: none;"><label for="cf_recommend_point">추천인 포인트</label></th>
						<td style="display: none;"><input type="text" name="cf_recommend_point" value="<?php echo (int) $config['cf_recommend_point'] ?>" id="cf_recommend_point" class="frm_input"> 점</td>
                    </tr>
                    <tr>

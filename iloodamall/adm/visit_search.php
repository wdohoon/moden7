...
<div class="local_sch local_sch01">
    ...
    <select name="sfl" id="sch_sort" class="search_sort">
        ...
        <option value="vi_date"<?php echo get_selected($sfl, 'vi_id'); ?>>아이디</option>
        <option value="vi_date"<?php echo get_selected($sfl, 'vi_read'); ?>>읽기</option>
        <option value="vi_date"<?php echo get_selected($sfl, 'vi_append'); ?>>추가</option>
        <option value="vi_date"<?php echo get_selected($sfl, 'vi_change'); ?>>변경</option>
        <option value="vi_date"<?php echo get_selected($sfl, 'vi_delete'); ?>>삭제</option>
    </select>

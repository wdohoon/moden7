...
$sql = " update {$g5['config_table']}
            set cf_title = '{$cf_title}',
                ...
                cf_use_money = '{$_POST['cf_use_money']}',
                cf_money_term = '{$_POST['cf_money_term']}',

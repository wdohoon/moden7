...
if ($csv == 'xls')
{
    ...
    $sql = " SELECT a.od_id, od_b_zip1, od_b_zip2, od_b_addr1, od_b_addr2, od_b_addr3, od_b_addr_jibeon, od_b_name, od_b_tel, od_b_hp, b.it_name, ct_qty, b.it_id, a.od_id, od_memo, od_invoice, b.ct_option, b.ct_send_cost, b.it_sc_type
              ...
              where a.od_id = b.od_id ";
	*/
	$sql = " SELECT a.od_id, a.od_name, a.od_settle_case, a.od_receipt_time, a.od_receipt_price, a.od_cart_price, a.od_deposit_name, a.od_receipt_point, a.od_time, a.mb_id, od_b_zip1, od_b_zip2, od_b_addr1, od_b_addr2, od_b_addr3, od_b_addr_jibeon, od_b_name, a.od_status, a.od_email, od_b_tel, od_b_hp, b.it_name, ct_qty, b.it_id, a.od_id, od_memo, od_invoice, b.ct_option, b.ct_send_cost, b.it_sc_type
               FROM {$g5['g5_shop_order_table']} a, {$g5['g5_shop_cart_table']} b
              where a.od_id = b.od_id ";
    ...
    if (!$cnt)
        ...
        $widths  = array(20, 15, 20, 15, 10, 10, 10, 40, 5, 15, 15, 10, 20, 20, 20, 50, 15, 15, 15, 15, 15, 15, 15, 15, 10, 10);

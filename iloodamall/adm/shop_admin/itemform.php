...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="it_link">브랜드사이트 링크주소</label></th>
            <td>
                <?php echo help("제품의 외부 브랜드사이트로 연결하는 링크주소가 필요한 경우에 입력합니다."); ?>
                <input type="text" name="it_link" value="<?php echo get_text(html_purifier($it['it_link'])); ?>" id="it_link" class="frm_input" size="95" placeholder="예) https://reepotlaser.com">
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_link" value="1" id="chk_ca_it_link">
                <label for="chk_ca_it_link">분류적용</label>
                <input type="checkbox" name="chk_all_it_link" value="1" id="chk_all_it_link">
                <label for="chk_all_it_link">전체적용</label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th scope="row"><label for="it_model">규격</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
        ...
        <tr>
            <th scope="row"><label for="it_tel_inq">문의 상품</label></th>
            <td>
                <?php echo help("금액 대신 문의로 표시됩니다. * 체크할 경우 구매가 아닌, 문의하기로 전환됩니다."); ?>

...
<section id="anc_sodr_pay">
    ...
    if ($od['od_receipt_point'] > 0)
		...
		$sql_i = "select g5_shop_item.ca_id from g5_shop_cart join g5_shop_item on g5_shop_cart.it_id = g5_shop_item.it_id where g5_shop_cart.od_id = '{$od['od_id']}'";
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
			...
			<?
			if($row_i['ca_id'] == 40){
				echo "<th scope='col'>적립금결제</th>";
			} else {
				echo "<th scope='col'>포인트결제</th>";
			}?>
        ...
        <tr>
			...
			<?php 
			if($row_i['ca_id'] == 40){
				echo display_point2($od['od_receipt_point']); 
			} else {
    ...
    <div class="compare_wrap">
                        ...
                        if ($od['od_settle_case'] != '무통장') {
                            switch($od['od_pg']) {
                                ...
                                case 'KAKAOPAY':
                                    ...
                                    $pg_test = 'KAKAOPAY';
                                    break;
								case 'nicepay': // acefive
                                    $pg_url  = 'https://pg.nicepay.co.kr/home/Login.jsp';
                                    $pg_test = '나이스페이';
                                    break;
                                default:
        ...
        <section id="anc_sodr_paymo" class="compare_right">
            ...
            <div class="tbl_frm01">
				...
				?>
                <tr>
                    <th scope="row"><label for="od_receipt_point">적립금 결제액</label></th>
                    <td><input type="text" name="od_receipt_point" value="<?php echo $od['od_receipt_point']; ?>" id="od_receipt_point" class="frm_input" size="10"> 원</td>
                </tr>
				<? } else { ?>
                <tr>

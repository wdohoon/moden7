...
if(isset($_FILES['excelfile']['tmp_name']) && $_FILES['excelfile']['tmp_name']) {
	...
	$od_invoice          = isset($rowData[0][1]) ? addslashes($rowData[0][1]) : '';
        $od_delivery_company = isset($rowData[0][2]) ? addslashes($rowData[0][2]) : '';
        $od_name = isset($rowData[0][3]) ? addslashes($rowData[0][3]) : '';
        $mb_1 = isset($rowData[0][4]) ? addslashes($rowData[0][4]) : '';
        $it_name = isset($rowData[0][5]) ? addslashes($rowData[0][5]) : '';
        $ct_qty = isset($rowData[0][6]) ? addslashes($rowData[0][6]) : '';
        $od_b_name = isset($rowData[0][7]) ? addslashes($rowData[0][7]) : '';
        $od_b_tel = isset($rowData[0][8]) ? addslashes($rowData[0][8]) : '';
        $od_b_hp = isset($rowData[0][9]) ? addslashes($rowData[0][9]) : '';
        $full_address = isset($rowData[0][10]) ? addslashes($rowData[0][10]) : '';
        $od_lotnumber = isset($rowData[0][11]) ? addslashes($rowData[0][11]) : '';
...
$od_hp = $od['od_hp'];
include_once(G5_PATH.'/kakao/delivery_ok.php');

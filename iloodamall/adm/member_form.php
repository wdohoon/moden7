...
<style>
.none{display: none;}
table .img_wrap img{max-width:400px; width: 100%;}
</style>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th scope="row">추천인</th>
                    <td colspan="3"><input type="text" name="mb_recommend" value="<?php echo ($mb['mb_recommend'] ? get_text($mb['mb_recommend']) : '없음'); ?>" id="mb_recommend" class="frm_input" size="15" maxlength="20"></td>
					<?php } ?>
                </tr>
				<tr>
					<th scope="row">MP</th>
                    <td><a href="./point2_list.php?sfl=mb_id&amp;stx=<?php echo $mb['mb_id'] ?>" target="_blank"><?php echo number_format($mb['mb_point2']) ?></a> 원</td>
					<th scope="row">PP</th>
                    <td><a href="./point_list.php?sfl=mb_id&amp;stx=<?php echo $mb['mb_id'] ?>" target="_blank"><?php echo number_format($mb['mb_point']) ?></a> 점</td>
				</tr>
                <tr>
                    <th scope="row"><label for="mb_1">소속 병원<strong class="sound_only">필수</strong></label></th>
                    <td><input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1" maxlength="100" required class="required frm_input" size="30"></td>
                    <th scope="row"><label for="mb_2">사업자 등록번호</label></th>
                    <td><input type="text" name="mb_2" value="<?php echo $mb['mb_2'] ?>" id="mb_2" class="frm_input" maxlength="255" size="15"></td>
                </tr>
				<tr class="img_wrap">
                ...
                <tr>
                    ...
                    <th scope="row"><label for="mb_10">분류</label></th>
                    <td>
						<select name="mb_10" id="mb_10"class="frm_input">
							<option value="" <?php if($mb['mb_10'] === '') echo 'selected'?>>분류를 선택하세요</option>
							<option value="DOCTOR" <?php if($mb['mb_10'] === 'DOCTOR') echo 'selected'?>>DOCTOR</option>
							<option value="MANAGER" <?php if($mb['mb_10'] === 'MANAGER') echo 'selected'?>>MANAGER</option>
						</select>
						<!-- <input type="text" name="mb_10" value="<?php echo $mb['mb_10'] ?>" id="mb_10" class="frm_input" maxlength="255" size="15"> -->
					</td>
                </tr>
                <tr>
                    <th scope="row"><label for="mb_hp">휴대폰번호</label></th>
                    <td><input type="text" name="mb_hp" value="<?php echo $mb['mb_hp'] ?>" id="mb_hp" class="frm_input" size="15" maxlength="20"></td>
                    <th scope="row" class="none"><label for="mb_tel">전화번호</label></th>
                    <td class="none"><input type="text" name="mb_tel" value="<?php echo $mb['mb_tel'] ?>" id="mb_tel" class="frm_input" size="15" maxlength="20"></td>
                </tr>
                <tr class="none">

...
$menu['menu200'] = array(
    ...
    //array('200810', '접속로그', G5_ADMIN_URL . '/visit_search.php', 'mb_search', 1),
    array('200710', '접속로그', G5_ADMIN_URL . '/view.php?call=login_history_list', 'login_history_list', 1),
    //array('200820', '접속자로그삭제', G5_ADMIN_URL . '/visit_delete.php', 'mb_delete', 1),
    array('200200', 'PP관리', G5_ADMIN_URL . '/point_list.php', 'mb_point'),
    array('200210', 'MP관리', G5_ADMIN_URL . '/point2_list.php', 'mb_point2'),

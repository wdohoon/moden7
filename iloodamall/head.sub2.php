...
<head>
<meta charset="utf-8">
<meta property="og:image" content="<?php echo G5_URL?>/images/thimg_w.png">
<?php
if (G5_IS_MOBILE) {
...
?>
<title><?php echo $g5_head_title; ?>123</title>
<?php
if (defined('G5_IS_ADMIN')) {
    ...
    echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/'.(G5_IS_MOBILE?'mobile':'default').'_shop'.$shop_css.'.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
}
?>
<!--[if lte IE 8]>

...
<div class="sub_wrap sub_content2">
<form name="forderform" id="forderform" method="post" action="<?php echo $order_action_url; ?>" autocomplete="off">
<div id="sod_frm">
	<div class="sod_frm_pc">
    <!-- 주문상품 확인 시작 { -->
		<div class="tbl_head03 tbl_wrap od_prd_list">
			...
			if ($i == 0) {
				...
				alert('장바구니가 비어 있습니다.', '/creative-marketing/list.php?ca_id=40');
			} else {
				// 배송비 계산
	...
	<div class="sod_frm_mo">
				<ul class="sod_list">
					...
					<li class="sod_li">
						...
						<div class="total_price total_span"><span>주문금액 </span><strong><?php echo number_format($sell_price); ?></strong>원</div>
        ...
        <section id="sod_frm_orderer">
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td><input type="text" name="od_hp" required value="<?php echo get_text($member['mb_hp']); ?>" id="od_hp" class="frm_input required" maxlength="20"></td>
                </tr>
                <tr>
                    <th scope="row">주소</th>
                    <td>
        ...
        <section id="sod_frm_taker">
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td><textarea name="od_memo" id="od_memo" placeholder="희망 날짜 : &#13;&#10;요청사항 : "></textarea></td>
                </tr>
                </tbody>
                </table>
            </div>
    ...
    <div class="sod_right">
        ...
        <section id="sod_frm_pay">
            ...
            <div id="od_pay_sl">
                ...
                $temp_point = 0;
                // 회원이면서 적립금사용이면
                if ($is_member && $config['cf_use_money'])
                {
                    // 적립금 결제 사용 적립금보다 회원의 적립금이 크다면
                    if ($member['mb_point2'] >= $default['de_settle_min_money'])
                    {
                        $temp_point = (int)$default['de_settle_max_money'];

                        if($temp_point > (int)$tot_sell_price)
                            $temp_point = (int)$tot_sell_price;

                        if($temp_point > (int)$member['mb_point2'])
                            $temp_point = (int)$member['mb_point2'];

                        $point_unit = (int)$default['de_settle_money_unit'];
                        $temp_point = (int)((int)($temp_point / $point_unit) * $point_unit);
                ?>
				</div>
                <div class="sod_frm_point">
                    <div>
                        <label for="od_temp_point">사용 적립금(<?php echo $point_unit; ?>원 단위)</label>
                        <input type="hidden" name="max_temp_point" value="<?php echo $temp_point; ?>">
                        <input type="text" name="od_temp_point" value="0" id="od_temp_point"  size="7"> 원
                    </div>
                    <div id="sod_frm_pt">
                        <span><strong>보유적립금</strong><?php echo display_point2($member['mb_point2']); ?></span>
                        <span class="max_point_box"><strong>최대 사용 가능 적립금</strong><em id="use_max_point"><?php echo display_point2($temp_point); ?></em></span>
                    </div>
                </div>
                <?php
                    $multi_settle++;
...
$(function() {
    ...
    $("#sc_coupon_btn").click(function() {
        ...
        $.post(
            ".../shop/shop/ordersendcostcoupon.php",

...
<style>
#sit {margin:0 0 10px;padding-bottom:110px;}
...
#sit_ov div.info_box {float:right;width:342px;}
...
#sit_ov div.info_box p.date_n:after {content:"설치 희망일"}

#sit_ov div.info_box p.after input {height:30px;}

#sit_ov div.price_box {float:right;width:342px;position:relative;}
...
#sit_ov div.price_box.inquiry {margin-top:15px;}
#sit_ov div.price_box.inquiry:after {content:"요청 메모란";display:block;position:absolute;left:-115px;top:5px;color:#999;font-size: 16px;font-weight: 400;line-height: 30px;}
...
#sit_ov div.price_box #sit_ov_btn a {width:49%;}
#sit_ov div.price_box #sit_ov_btn #btn_submit {float:left;display: inline-block;width: 49%;height: 50px;line-height: 50px;color: #fff;font-size: 1.6em;margin-right:2%;border: 1px solid #000;text-align: center;background:#000;cursor:pointer;border-radius: 3px;font-weight: bold;}
#sit_ov div.price_box #sit_ov_btn button.sit_btn_buy {width:100%;background:#000;border-color:#000;margin-top: 10px;}
...
#sit_tab .tab_tit li button {display:block;width:100%;position:relative;font-size:1.2em;padding:10px 15px;border:0;color:#666;background:#d9d9d9;line-height:38px;text-align:center;z-index:1}
#sit_tab .tab_tit li .selected {background:#000;z-index:2;border-bottom-color:#fff;color:#fff;font-weight:bold}
...
#sit_pvi_big img {width:1080px;height:auto}
...
#sit_ov div.price_box {width:19.4318vw;}
#sit_ov div.price_box.price:after {left:-6.5341vw;top:0.2841vw;font-size: 0.9091vw;line-height: 1.7045vw;}
#sit_ov div.price_box.inquiry {margin-top:0.8523vw;}
#sit_ov div.price_box.inquiry:after {left:-6.5341vw;top:0.2841vw;font-size: 0.9091vw;line-height: 1.7045vw;}
#sit_ov div.price_box .sit_option {padding:0;}
#sit_ov div.price_box .sit_option label {}
#sit_ov div.price_box .sit_option select {margin:0;}
#sit_ov div.price_box #sit_ov_btn button {width:49%;margin-right:0;height: 2.8409vw;line-height: 2.8409vw;font-size: 1.6em;border: 0.0568vw solid #000;border-radius: 0.1705vw;}
#sit_ov div.price_box #sit_ov_btn a {width:49%;height: 2.8409vw;line-height: 2.8409vw;font-size: 1.6em;border: 0.0568vw solid #000;border-radius: 0.1705vw;}
#sit_ov div.price_box #sit_ov_btn #btn_submit {width: 49%;height: 2.8409vw;line-height: 2.8409vw;font-size: 1.6em;border: 0.0568vw solid #000;border-radius: 0.1705vw;}
...
#sit_pvi_big img {width:61.3636vw;height:auto}
#sit_pvi_thumb {margin:0;padding:0;list-style:none;text-align:center}
...
#sit {margin:0 0 0.6250vw;padding-bottom:6.8750vw;}
...
#sit_ov div.price_box {width:21.3750vw;}
#sit_ov div.price_box.price:after {left:-7.1875vw;top:0.3125vw;font-size: 1.0000vw;line-height: 1.8750vw;}
#sit_ov div.price_box.inquiry {margin-top:0.9375vw;}
#sit_ov div.price_box.inquiry:after {left:-7.1875vw;top:0.3125vw;font-size: 1.0000vw;line-height: 1.8750vw;}
#sit_ov div.price_box .sit_option {padding:0;}
#sit_ov div.price_box .sit_option label {}
#sit_ov div.price_box .sit_option select {margin:0;}
#sit_ov div.price_box #sit_ov_btn button {width:49%;margin-right:0;height: 3.1250vw;line-height: 3.1250vw;font-size: 1.6em;border: 0.0625vw solid #000;border-radius: 0.1875vw;}
#sit_ov div.price_box #sit_ov_btn a {width: 49%;height: 3.1250vw;line-height: 3.1250vw;font-size: 1.6em;border: 0.0625vw solid #000;border-radius: 0.1875vw;}
#sit_ov div.price_box #sit_ov_btn #btn_submit {width: 49%;height: 3.1250vw;line-height: 3.1250vw;font-size: 1.6em;border: 0.0625vw solid #000;border-radius: 0.1875vw;}
...
#sit_pvi {position:relative;width:60.0000vw;}
#sit_pvi_big {text-align:center}
#sit_pvi_big a {display:none}
#sit_pvi_big a.visible {display:block}
...
#sit_pvi_big img {width:60.0000vw;height:auto}
#sit_pvi_thumb {margin:0;padding:0;list-style:none;text-align:center}
#sit_pvi_thumb:after {visibility:hidden;clear:both;content:""}
...
#sit_ov div.price_box {width:24.4286vw;}
#sit_ov div.price_box.price:after {left:-8.2143vw;top:0.3571vw;font-size: 1.1429vw;line-height: 2.1429vw;}
#sit_ov div.price_box.inquiry {margin-top:1.0714vw;}
#sit_ov div.price_box.inquiry:after {left:-8.2143vw;top:0.3571vw;font-size: 1.1429vw;line-height: 2.1429vw;}
#sit_ov div.price_box .sit_option {padding:0;}
#sit_ov div.price_box .sit_option label {}
#sit_ov div.price_box .sit_option select {margin:0;}
#sit_ov div.price_box #sit_ov_btn button {width:49%;margin-right:0;height: 3.5714vw;line-height: 3.5714vw;font-size: 1.6em;border: 0.0714vw solid #000;border-radius: 0.2143vw;}
#sit_ov div.price_box #sit_ov_btn a {width: 49%;height: 3.5714vw;line-height: 3.5714vw;font-size: 1.6em;border: 0.0714vw solid #000;border-radius: 0.2143vw;}
#sit_ov div.price_box #sit_ov_btn #btn_submit {width: 49%;height: 3.5714vw;line-height: 3.5714vw;font-size: 1.6em;border: 0.0714vw solid #000;border-radius: 0.2143vw;}
...
#sit_pvi_big img {width:68.5714vw;height:auto}
#sit_pvi_thumb {margin:0;padding:0;list-style:none;text-align:center}
#sit_pvi_thumb:after {visibility:hidden;clear:both;content:""}
...
#sit {margin:0 0 0.9766vw;padding-bottom:10.7422vw;}
...
#sit_ov div.price_box.inquiry {margin-top:1.4648vw;}
#sit_ov div.price_box.inquiry:after {left:-11.2305vw;top:0.4883vw;font-size: 1.5625vw;line-height: 2.9297vw;}
#sit_ov div.price_box .sit_option {padding:0;}
#sit_ov div.price_box .sit_option label {}
#sit_ov div.price_box .sit_option select {margin:0;}
#sit_ov div.price_box #sit_ov_btn button {width:49%;margin-right:0;height: 4.8828vw;line-height: 4.8828vw;font-size: 1.6em;border: 0.0977vw solid #000;border-radius: 0.2930vw;}
#sit_ov div.price_box #sit_ov_btn a {width: 49%;height: 4.8828vw;line-height: 4.8828vw;font-size: 1.6em;border: 0.0977vw solid #000;border-radius: 0.2930vw;}
#sit_ov div.price_box #sit_ov_btn #btn_submit {width: 49%;height: 4.8828vw;line-height: 4.8828vw;font-size: 1.6em;border: 0.0977vw solid #000;border-radius: 0.2930vw;}
...
#sit_pvi_big img {width:93.7500vw;height:auto}
#sit_pvi_thumb {margin:0;padding:0;list-style:none;text-align:center}
#sit_pvi_thumb:after {visibility:hidden;clear:both;content:""}
...
#sit {margin:0 0 1.3021vw;padding-bottom:10.4167vw;}
...
#sit_ov div.price_box.price:after {left:0;top:-5.2083vw;font-size: 2.0833vw;line-height: 3.9063vw;}
#sit_ov div.price_box.inquiry {margin-top:5.2083vw;}
#sit_ov div.price_box.inquiry:after {left:0;top:-5.2083vw;font-size: 2.0833vw;line-height: 3.9063vw;}
#sit_ov div.price_box .sit_option {padding:0;}
#sit_ov div.price_box .sit_option label {}
#sit_ov div.price_box .sit_option select {margin:0;}
#sit_ov div.price_box #sit_ov_btn button {width:49%;margin-right:0;height: 6.5104vw;line-height: 6.5104vw;font-size: 1.2em;border: 0.1302vw solid #000;border-radius: 0.3906vw;}
#sit_ov div.price_box #sit_ov_btn a {width: 49%;height: 6.5104vw;line-height: 6.5104vw;font-size: 1.2em;border: 0.1302vw solid #000;border-radius: 0.3906vw;}
#sit_ov div.price_box #sit_ov_btn #btn_submit {width: 49%;height: 6.5104vw;line-height: 6.5104vw;font-size: 1.2em;border: 0.1302vw solid #000;border-radius: 0.3906vw;}
...
#sit_pvi_big img {width:125.0000vw;height:auto}
#sit_pvi_thumb {margin:0;padding:0;list-style:none;text-align:center}
#sit_pvi_thumb:after {visibility:hidden;clear:both;content:""}
...
#sit {margin:0 0 2.0833vw;padding-bottom:16.6667vw;}
...
#sit_ov div.info_box p.desc {font-size: 3.3333vw;line-height: 6.2500vw;}
#sit_ov div.info_box p.after {}
#sit_ov div.info_box p.after:after {left:0;top:0;}
#sit_ov div.info_box p.after input {height:6.2500vw;width:27.0833vw;}

#sit_ov div.price_box {width:100%;margin-top:8.3333vw;}
#sit_ov div.price_box.price:after {left:0;top:-8.3333vw;font-size: 3.3333vw;line-height: 6.2500vw;}
#sit_ov div.price_box.inquiry {margin-top:8.3333vw;}
#sit_ov div.price_box.inquiry:after {left:0;top:-8.3333vw;font-size: 3.3333vw;line-height: 6.2500vw;}
#sit_ov div.price_box .sit_option {padding:0;}
#sit_ov div.price_box .sit_option label {}
#sit_ov div.price_box .sit_option select {margin:0;}
#sit_ov div.price_box #sit_ov_btn button {width:49%;margin-right:0;height: 10.4167vw;line-height: 10.4167vw;font-size: 1.2em;border: 0.2083vw solid #000;border-radius: 0.6250vw;}
#sit_ov div.price_box #sit_ov_btn a {width:49%;height: 10.4167vw;line-height: 10.4167vw;font-size: 1.2em;border: 0.2083vw solid #000;border-radius: 0.6250vw;}
#sit_ov div.price_box #sit_ov_btn #btn_submit {width: 49%;height: 10.4167vw;line-height: 10.4167vw;font-size: 1.2em;border: 0.2083vw solid #000;border-radius: 0.6250vw;}
...
#sit_pvi_big img {width:200.0000vw;height:auto}
...
<div id="sit_ov_from">
	...
	<form name="fitem" method="post" action="/creative-marketing/cartupdate.php" onsubmit="return fitem_submit(this);">
	...
	<div id="sit_ov_wrap">
	    ...
	    <section id="sit_ov" class="2017_renewal_itemform">
			...
			<form action="/bbs/write_update.php" method="post" class="qe_form clearfix" onsubmit="return fwrite_submit(this);" enctype="multipart/form-data" autocomplete="off">
				...
				<input type="hidden" id="wr_1" name="wr_1" value="<?php echo $it['it_name']?>" />
				<input type="hidden" id="wr_2" name="wr_2" value="<?php echo $it['it_basic']?>" />
				<input type="hidden" id="wr_3" name="wr_3" value="<?php echo $it['it_brand']?>" />
				<input type="hidden" id="wr_4" name="wr_4" value="<?php echo $it['it_id']?>" />
				<input type="hidden" id="wr_5" name="wr_5" value="<?php echo $it['ca_name']?>" />
				<input type="hidden" id="wr_subject" name="wr_subject" value="제품신청 - <?php echo $member['mb_id']?>" />
			<?php } ?>
			...
			<div class="info_box">
				...
				<?php } ?>
				<?php if($it['it_tel_inq']) { ?>
				<p class="desc after date_n">
					<input type="date" name="wr_6" id="wr_6" placeholder="제품명" required class="frm_input" maxLength="40" onKeyUp="result(this);"> - 
					<input type="date" name="wr_7" id="wr_7" placeholder="제품 시리얼 넘버" required class="frm_input" maxLength="40" onKeyUp="result(this);">
				</p>
				<?php } ?>
			</div>
			<?php if($it['it_tel_inq']) { ?>
			<div class="price_box inquiry">
				<div class="textarea">
					<textarea name="wr_content" id="wr_content" cols="30" rows="10" placeholder="요청 메모란"></textarea>	
				</div>
			<?php } else { ?>
	        ...
	        <div id="sit_ov_btn">
	            ...
	            <?php } else { ?>
				<input type="submit" value="제품신청" id="btn_submit" accesskey="s" class="">
				<?php } ?>
...
{
    f.action = "/creative-marketing/cartupdate.php";
    f.target = "";

			...
			<div class="sod_fin_list_pc">
				...
				<div class="tbl_head03 tbl_wrap">
					...
					for($i=0; $row=sql_fetch_array($result); $i++) {
						$image = get_it_image($row['it_id'], 100, 0);
					...
					<?php
							...
							$st_count1++;
							if($opt['ct_status'] == '주문' || ($opt['ct_status'] == '입금' && ($od['od_settle_case'] == '신용카드' || $od['od_settle_case'] == '간편결제')))
								$st_count2++;
						}
					}
			...
			<div class="sod_fin_list_mo">
				...
				<ul id="sod_list_inq" class="sod_list">
					...
					for($i=0; $row=sql_fetch_array($result); $i++) {
						$image_width = 65;
						$image_height = 65;
						$image = get_it_image($row['it_id'], 120, 0, '', '', $row['it_name']);
					...
					<li class="sod_li">
						...
						<div class="li_total">
							<span class="total_price total_span"><span>주문금액 </span><strong><?php echo number_format($sell_price); ?></strong>원</span>
						</div>
						<?php
						}
						?>
			...
			<section id="sod_fin_pay">
				...
				<div class="tbl_head01 tbl_wrap">
					...
					<tr>
						...
						<td><?php echo display_point2($od['od_receipt_point']); ?></td>
					</tr>
					...
					<tr>
						...
						?>
							<a href="javascript:;" onclick="<?php echo $cash_receipt_script; ?>" class="btn_frmline btn_receipt">현금영수증 확인하기</a>
						<?php
						}
						else
						{
						?>
							<a href="javascript:;" onclick="window.open('<?php echo G5_SHOP_URL; ?>/taxsave.php?od_id=<?php echo $od_id; ?>', 'taxsave', 'width=550,height=400,scrollbars=1,menus=0');" class="btn_frmline btn_receipt">현금영수증을 발급하시려면 클릭하십시오.</a>
						<?php } ?>
						</td>
					</tr>
					<?php
			...
			<section id="sod_fin_tot">
				...
				<ul>
					...
					<li id="alrdy">
						...
						<div class="right">
							<p><span class="title"><i class="fa fa-angle-right" aria-hidden="true"></i> 적립금 결제</span><?php echo number_format($od['od_receipt_point']); ?> 원</p>

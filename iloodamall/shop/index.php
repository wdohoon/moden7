...
.txt_div h1 {color:#000; font-size: 20px;line-height: 20px;margin-bottom: 15px; font-weight:400;}
.txt_div p {font-size: 16px;line-height: 24px;}
.txt_div a.detail {position:absolute;right:0;bottom:0;font-size: 16px;}

/* 아코디언 */
.main_box_wrap ul.ac {width:100%;height:670px;margin:0px auto;overflow:hidden;}
...
.main_box_wrap ul.ac li.slide_box {float:left;width:360px;height:100%;transition:0.8s;background:#d5dbe7;box-shadow:6px 6px 50px rgba(0 0 0 / .8);}
...
.main_box_wrap ul.ac li.slide_box.nom02.on {background:url('/images/gadi3_banner.png')no-repeat center / cover;}
.main_box_wrap ul.ac li.slide_box.nom04.on {background:url('/images/demo3_banner.png')no-repeat center / cover;}
.main_box_wrap ul.ac li.slide_box.nom03.on {background:url('/images/class_banner3.png')no-repeat center / cover;}
.main_box_wrap ul.ac li.slide_box.nom01.on {background:url('/images/fortra1.jpg')no-repeat center / cover;}
...
.main_box_wrap ul.ac li.slide_box {width:27%;height:100%;transition:0.8s;background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom01 {background:#b0c4df;}
.main_box_wrap ul.ac li.slide_box.nom01.color {background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom02 {background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom02.color {background:#b0c4df;}
...
.main_box_wrap ul.ac li.slide_box.nom03.color {background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom04 {background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.on {width: 50%;}
...
.main_box_wrap ul.ac li.slide_box {width:24%;height:100%;transition:0.8s;background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom01 {background:#b0c4df;}
.main_box_wrap ul.ac li.slide_box.nom01.color {background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom02 {background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom02.color {background:#b0c4df;}
...
.main_box_wrap ul.ac li.slide_box {width:16%;height:100%;transition:0.8s;background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom01 {background:#b0c4df;}
.main_box_wrap ul.ac li.slide_box.nom01.color {background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom02 {background:#d5dbe7;}
.main_box_wrap ul.ac li.slide_box.nom02.color {background:#b0c4df;}
			...
			<ul class="ac">
				...
				<li class="slide_box nom01 on">
					...
					<div class="img_div on">
						<div class="txt_boxer">
							<p class="img_title mont" style="color:#fff;">ilooda PRODUCT</p>
							<p class="main_title" style="color:#fff;">
								무한한 가능성,<br/>포트라를<br/>직접 경험해보세요.
							</p>
							<a href="/shop/item.php?it_id=1711607914" class="submit_btn">신청하러가기</a>
						</div>
					</div>
				</li>
				...
				<li class="slide_box nom03" style="display:none;">
					<div class="text_div">
						<div class="txt_wrapper">
							<p class="ilooda_title mont">ilooda CHIEF CLASS</p>
							<p class="ilooda_desc">
								제 4회차 리팟 <br/>
								치프 클래스에 <br/>
								병원 임직원을 초대합니다.
					...
					<div class="img_div">
						<div class="txt_boxer">
							<p class="img_title mont" style="color:#fff">ilooda CHIEF CLASS</p>
							<p class="main_title" style="color:#fff;">
								제4회 리팟 치프 클래스에<br>병원 임직원을 초대합니다.
							</p>
							<?php
							// 로그인 상태 체크
							$is_logged = isset($_SESSION['ss_mb_id']) && $_SESSION['ss_mb_id'];
				
							// 로그인 상태에 따라 다르게 처리
							if ($is_logged) {
								// 로그인한 경우, 링크 정상 작동
								echo '<a href="https://forms.gle/Kz4nKPSwA46HgBRb8" class="submit_btn">클래스 신청 바로가기</a>';
							} else {
								// 로그인하지 않은 경우, JavaScript Alert 사용
								echo '<a href="javascript:;" class="submit_btn" onclick="alert(\' 회원가입후 치프클래스 방문가능합니다. \');">클래스 신청 바로가기</a>';
							}
							?>
						</div>
					</div>
				...
				<li class="slide_box nom04">
					...
					<div class="img_div">
						<div class="txt_boxer">
							...
							<a href="/shop/item.php?it_id=1692860155" class="submit_btn">신청하러가기</a>
						</div>
					</div>
				</li>

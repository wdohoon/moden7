...
if (!$is_member){
    //alert("로그인이 필요합니다.", G5_SHOP_URL."/mypage.php");
}
...
#sct .inner p {color:#b1b4b9; font-size: 60px;font-weight: 700;letter-spacing:-0.04em;margin-bottom: 50px;}
...
<?php
if($ca_id == '10' || $ca_id == '1010' || $ca_id == '1020' || $ca_id == '1030' || $ca_id == '1040' || $ca_id == '1050' || $ca_id == '1060') {
	$list_name = '제품군';
}
if($ca_id == '20' || $ca_id == '2010' || $ca_id == '2020' || $ca_id == '2030' || $ca_id == '2040' || $ca_id == '2050' || $ca_id == '2060' || $ca_id == '2070' || $ca_id == '2080') {
	$list_name = '소모품';
}
if($ca_id == '30' || $ca_id == '3010') {
	$list_name = '코스메틱';
}

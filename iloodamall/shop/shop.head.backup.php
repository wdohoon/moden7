...
#hd_util li.genuine {background:#000;width:80px;padding:0;border-radius:5px; margin-right: 10px;}
#hd_util li.genuine a {color:#fff;display: block;}
#hd_util li.ilooda{ padding: 0;}
#hd_util li.ilooda a{display: block;border:1px solid #555; border-radius:5px; height: 36px;padding:0 5px;position:relative;width:89px;}
...
#hd_util li.genuine {width:4.5455vw;padding:0;border-radius:0.2841vw;margin-right:0.5682vw;}
#hd_util li.ilooda{}
#hd_util li.ilooda a{display: block;border:0.0568vw solid #555; border-radius:0.2841vw;height:2.0455vw;width:5.0568vw;}
#hd_util li.ilooda a img{/* width:5.0568vw; height:auto; */}
...
#hd_util li.genuine {width:5.0000vw;padding:0;border-radius:0.3125vw;margin-right: 0.6250vw;}
#hd_util li.ilooda{}
#hd_util li.ilooda a{display: block;border:0.0625vw solid #555; border-radius:0.3125vw;height:2.2500vw;width:5.5625vw;}
#hd_util li.ilooda a img{/* width:5.5625vw; height:auto; */}
...
#hd_util li.genuine {width:5.7143vw;padding:0;border-radius:0.3571vw;margin-right: 0.7143vw;}
#hd_util li.ilooda{}
#hd_util li.ilooda a{display: block;border:0.0714vw solid #555; border-radius:0.3571vw;height:2.5714vw;width:6.3571vw;}
#hd_util li.ilooda a img{/* width:6.3571vw; height:auto; */}
...
#hd_util li.genuine {width:7.8125vw;padding:0;border-radius:0.4883vw;margin-right: 0.9766vw;}
#hd_util li.ilooda{}
#hd_util li.ilooda a{display: block;border:0.0977vw solid #555; border-radius:0.4883vw;height:3.5156vw;width:8.6914vw;}
#hd_util li.ilooda a img{width:6.3571vw; height:auto;}

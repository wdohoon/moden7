...
/* util */
#hd_util {float:right;padding-top:28px;padding-bottom: 10px;}
#hd_util:after {display:block;visibility:hidden;clear:both;content:""}
#hd_util li {float:left;font-size:14px;line-height:26px;position:relative;text-align:center;padding:0 18px;}
...
#hd_util li a {display:inline-block;color:#666;font-size: 12px;font-weight:500;}
...
#hd_util li.ilooda a{display: block;border:1px solid #555; height: 26px;padding:0 5px;position:relative;width:120px;}
#hd_util li.ilooda a img{max-width:100%;height:auto;position:absolute;left:50%;top:50%;transform:translate(-50%,-50%)}
#hd_util li.select {width:120px;height:26px;margin-left:10px;}
#hd_util li select {height:26px;border:1px solid #555;padding-left:10px;width:120px;position:absolute;left:0;top:0}
...
.gnb_box .gnb_wrapper > li > a {padding:0 30px;font-size: 18px;font-weight: 400;letter-spacing:-0.02em;display:block;line-height:90px;}
.gnb_box .gnb_wrapper > li .lnb_wrapper {display:none;padding-top:20px;position:absolute;left:0;top:90px;}
.gnb_box .gnb_wrapper > li .lnb_wrapper li {padding-left:30px;line-height:24px;}
.gnb_box .gnb_wrapper > li .lnb_wrapper li a {font-size: 14px;}
...
/* util */
#hd_util {padding-top:1.5909vw;padding-bottom: 0.5682vw;}
...
#hd_util li.ilooda{ padding: 0;}
#hd_util li.ilooda a{border:0.0568vw solid #555; height: 1.4773vw;padding:0 0.2841vw;width:6.8182vw;}
...
#hd_util li select {height:1.4773vw;border:0.0568vw solid #555;padding-left:0.5682vw;width:6.8182vw;left:0;top:0}
...
.gnb_box .gnb_wrapper > li .lnb_wrapper li {padding-left:1.7045vw;line-height:1.3636vw;}
...
/* util */
#hd_util {padding-top:1.7500vw;padding-bottom: 0.6250vw;}
#hd_util:after {visibility:hidden;clear:both;content:""}
...
#hd_util li.genuine a {}
#hd_util li.ilooda{ padding: 0;}
#hd_util li.ilooda a{border:0.0625vw solid #555; height: 1.6250vw;padding:0 0.3125vw;width:7.5000vw;}
#hd_util li.ilooda a img{max-width:100%;height:auto;left:50%;top:50%;transform:translate(-50%,-50%)}
#hd_util li.select {width:7.5000vw;height:1.6250vw;margin-left:0.6250vw;}
#hd_util li select {height:1.6250vw;border:0.0625vw solid #555;padding-left:0.6250vw;width:7.5000vw;left:0;top:0}
...
.gnb_box .gnb_wrapper > li .lnb_wrapper li {padding-left:1.8750vw;line-height:1.5000vw;}
...
/* util */
#hd_util {padding-top:2.0000vw;padding-bottom: 0.7143vw;}
#hd_util:after {visibility:hidden;clear:both;content:""}
...
#hd_util li.genuine a {}
#hd_util li.ilooda{ padding: 0;}
#hd_util li.ilooda a{border:0.0714vw solid #555; height: 1.8571vw;padding:0 0.3571vw;width:8.5714vw;}
#hd_util li.ilooda a img{max-width:100%;height:auto;left:50%;top:50%;transform:translate(-50%,-50%)}
#hd_util li.select {width:8.5714vw;height:1.8571vw;margin-left:0.7143vw;}
#hd_util li select {height:1.8571vw;border:0.0714vw solid #555;padding-left:0.7143vw;width:8.5714vw;left:0;top:0}
...
.gnb_box .gnb_wrapper > li .lnb_wrapper li {padding-left:2.1429vw;line-height:1.7143vw;}
...
/* util */
#hd_util {padding-top:2.7344vw;padding-bottom: 0.9766vw;}
#hd_util:after {visibility:hidden;clear:both;content:""}
...
#hd_util li.genuine a {}
#hd_util li.ilooda{ padding: 0;}
#hd_util li.ilooda a{border:0.0977vw solid #555; height: 2.5391vw;padding:0 0.4883vw;width:11.7188vw;}
#hd_util li.ilooda a img{max-width:100%;height:auto;left:50%;top:50%;transform:translate(-50%,-50%)}
#hd_util li.select {width:11.7188vw;height:2.5391vw;margin-left:0.9766vw;}
#hd_util li select {height:2.5391vw;border:0.0977vw solid #555;padding-left:0.9766vw;width:11.7188vw;left:0;top:0}
...
.gnb_box .gnb_wrapper > li .lnb_wrapper li {padding-left:2.9297vw;line-height:2.3438vw;}
		...
		<div class="pc_wrap hide720">
			<div class="util_wrap">
				<ul id="hd_util">
					...
					<li class="no-line ilooda"><a href="https://www.ilooda.com/" target="_blank"><img src="/images/ilooda_1.png" alt=""></a></li>
					<li class="select no-line">
						<select onchange="if(this.value) window.open(this.value);">
							<option value="">Famliy Site</option>
							<option value="https://reepotlaser.com/">reepot</option>
							<option value="https://hyzerme.com/">hyzerme</option>
							<option value="https://ilooda.com/brand/secretRF.php">secretRF</option>
							<option value="https://ilooda.com/brand/veloce.php">veloce</option>
							<option value="https://ilooda.com/brand/fraxis.php">fraxis</option>
							<option value="https://ilooda.com/brand/healer1064.php">healer1064</option>
				...
				<ul class="gnb_wrapper">
					<li>
						...
						<ul class="lnb_wrapper">
							<li><a href="/shop/list.php?ca_id=1010">피부과</a></li>
							<li><a href="/shop/list.php?ca_id=1020">안과</a></li>
							<li><a href="/shop/list.php?ca_id=1030">기타</a></li>
						</ul>
					</li>
					<li>
						<a href="/shop/list.php?ca_id=20">소모품</a>
						<ul class="lnb_wrapper">
							<li><a href="/shop/list.php?ca_id=2010">리팟</a></li>
							<li><a href="/shop/list.php?ca_id=2020">하이저미</a></li>
							<li><a href="/shop/list.php?ca_id=2030">시크릿</a></li>
					...
					<li>
						...
						<ul class="lnb_wrapper">
							<li><a href="">리팟</a></li>
							<li><a href="">큐라스하이브리드</a></li>
							<li><a href="">펜토</a></li>
							<li><a href="">엔코어3D</a></li>
							<li><a href="">시크릿듀오</a></li>
							<li><a href="">벨로체</a></li>
							<li><a href="">프라시스듀오</a></li>
							<li><a href="">시크릿RF</a></li>
							<li><a href="">아큐트론</a></li>
							<li><a href="">하이저미</a></li>
							<li><a href="">cure.J</a></li>
							<li><a href="">레디캡쳐</a></li>
						</ul>
					</li>
					...
					<li>
						...
						<ul class="lnb_wrapper">
							...
							<li><a href="<?php echo get_pretty_url('faq'); ?>">FAQ</a></li>
							<li><a href="/bbs/write.php?bo_table=inquiry">1:1문의</a></li>
							<li><a href="/bbs/write.php?bo_table=mb_inquiry">문의</a></li>
						</ul>
					</li>
		...
		<div class="new_side_box_wrap">
			<div class="new_side_box01">
				...
				<div class="new_side_con01">
					<ul>
						<li><a class="nsc_btn nsc_btn01" href="javascript:alert('준비중입니다.');">인스타</a></li>
						<li><a class="nsc_btn nsc_btn02" href="javascript:alert('준비중입니다.');">카카오톡 상담</a></li>
						<li><a class="nsc_btn nsc_btn03" href="javascript:alert('준비중입니다.');">블로그</a></li>
						<li><a class="nsc_btn nsc_btn04" href="javascript:alert('준비중입니다.');">유튜브</a></li>
						<li><a class="nsc_btn nsc_btn07" href="javascript:alert('준비중입니다.');">페이스북</a></li>
						<li><a class="nsc_btn nsc_btn08" href="javascript:alert('준비중입니다.');">비메오</a></li>
						<li><a class="nsc_btn nsc_btn09" href="javascript:alert('준비중입니다.');">핀터레스트</a></li>
			...
			<div class="new_side_box02">
				...
				<div class="new_side_con02">
					<p class="new_side_text01">031-278-4660</p>
					<!-- <p class="new_side_text01"><?php echo $default['de_admin_company_tel']; ?></p> -->
					<p class="new_side_text02">MON-FRI</p>
					<p class="new_side_text02">AM 10:00 ~ PM 17:00</p>
					<p class="new_side_text02">LUNCH AM 12:30 ~ PM 13:30</p>
					<p class="new_side_text03">SAT, SUN, HOLIDAY : OFF</p>
					
					<div class="new_side_con0201">
						<a href="/bbs/write.php?bo_table=faq" class="new_side_btn01">FAQ</a>
...
$(function (){
	...
	$('.gnb_wrapper > li').on('mouseenter',function(){
		...
		$('.gnb_wrapper > li').find('ul').fadeIn(1000);

...
require_once(G5_SHOP_PATH.'/nicepay/lib/NicepayLiteLog.php');
require_once(G5_SHOP_PATH.'/nicepay/lib/NicepayLiteCommon.php');
	...
	function startAction() {
		...
		// 빌링 승인
		   ...
		   $this->m_uri = "/lite/billingProcess.jsp";
            ...
            $this->m_queryString["TrKey"] = $this->m_TrKey; // wetoz : 2020-10-29 : 추가
        ...
        // 2020-09-21 : 에스크로 배송등록
        if (trim($this->m_ActionType) == "PYO" && trim($this->m_PayMethod) == "ESCROW" ) {
		    // 에스크로 배송 등록

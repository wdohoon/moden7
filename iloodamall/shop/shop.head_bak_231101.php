				...
				<ul class="gnb_wrapper">
					...
					<li>
						...
						<ul class="lnb_wrapper">
							...
							<li><a href="/bbs/write.php?bo_table=inquiry">비회원문의</a></li>
					...
					<li>
						...
						<ul class="lnb_wrapper">
							<li><a href="/shop/guide.php">가이드영상</a></li>
						</ul>
					</li>
			...
			<div class="new_side_box01">
				...
				<div class="new_side_con01">
					<ul>
						...
						<li><a class="nsc_btn nsc_btn09" href="https://www.pinterest.co.kr/ilooda_official/" target="_blank">핀터레스트</a></li>
						...
						<li><a class="nsc_btn nsc_btn08" href="https://vimeo.com/user153508039" target="_blank">비메오</a></li>

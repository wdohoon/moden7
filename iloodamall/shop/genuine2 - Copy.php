				...
				<!-- <p class="alertmsg">
             	...
             	<form action="/bbs/write_update.php" method="post" class="qe_form clearfix" onsubmit="return fwrite_submit(this);" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="product-serial">
						<select name="input1" id="product_name" class="product-select">
						...
						<input type="text" name="inputtext1" id="serial_number" class="serial-input" placeholder="시리얼 넘버를 입력하세요." style="text-transform: uppercase;">
					</div>

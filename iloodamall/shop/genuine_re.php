...
#form_wrap form .ev_btn div input{ border: 1px solid #f1f1f1; background: #f1f1f1; color: #000; padding: 5px 0; margin-top: 10px; text-align: center;  border-radius: 40px; -webkit-transition: none;}

.fd{position:relative; display: flex; margin:0 auto; gap:20px; justify-content: center; border:1px solid;}
		...
		<div class="s_inner">
			<div id="form_wrap" class="form_wrap nanumS">
				...
				<form action="/bbs/write_update.php" method="post" class="qe_form clearfix" onsubmit="return fwrite_submit(this);" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="ev_btn">
						<div class="sCore fd">
							<select name="potencial" id="potencial" class="custom-select sources" placeholder="Project hiring">
							    <option value="DH" selected>Project hiring</option>

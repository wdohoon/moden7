...
?>
<style>
	.sub_content3{margin:100px auto;}
	@media(max-width: 1760px){
	.sub_content3{margin:5.6818vw auto;}
	}
	@media(max-width:1024px){
	.sub_content3{margin:9.7656vw auto;}
	}
	@media(max-width:768px){
	.sub_content3{margin:13.0208vw auto;}

	}
</style>
<!-- 주문 내역 시작 { -->
<div class="sub_wrap sub_content3">	
<div id="sod_v">
    <?php

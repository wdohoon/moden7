...
?>
<style>
.sct_10 .sct_cart {display: block;position: relative;}

.iconicon {position:absolute;left:5px;top:5px;z-index:9;}
.sct_10 li .sct_img .blbl {margin-right:5px;width:40px;height:40px;}

@media (max-width: 768px)  {
.sct_10 li .sct_img .blbl {margin-right:0.6510vw;width:5.2083vw;height:5.2083vw;}
}

@media (max-width: 480px)  {
.sct_10 li .sct_img .blbl {margin-right:1.0417vw;width:8.3333vw;height:8.3333vw;}
}
...
foreach((array) $list as $row){
    ...
    echo "<li class=\"sct_li \" data-css=\"nocss\" style=\"height:auto\">\n";
	...
	if ($this->view_it_basic && $row['it_basic']) {
        ...
        //echo "<button type=\"button\" class=\"btn_wish\" data-it_id=\"{$row['it_id']}\"><span class=\"sound_only\">위시리스트</span></button>\n";
		if(!$row['it_tel_inq']) {
		echo "<button type=\"button\" class=\"btn_cart sct_cart\" data-it_id=\"{$row['it_id']}\"></button>\n";
		echo "<button type=\"button\" class=\"btn_wish\" data-it_id=\"{$row['it_id']}\"></button>\n";
		}
        if ($this->view_sns) {

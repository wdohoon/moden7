   ...
   <!-- <div class="bo_fx">
    ...
    <div class="jtbl_head01 jtbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" class="hide_mo ">글쓴이</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_name hide_mo sv_use"><?php echo $list[$i]['name'] ?></td>
    ...
    <div class="bo_fx">
        <?php if ($is_checkbox && $is_admin == 'super') { ?>
        <ul class="btn_bo_adm">
            <li><span class="jbutton large black" ><input style="background:#b1b4b9" type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value"></span></li>
          <li><span class="jbutton large black"><input type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value" style="background:#b1b4b9"></span></li>
            <li><span class="jbutton large black"><input type="submit" name="btn_submit" value="선택이동" onclick="document.pressed=this.value" style="background:#b1b4b9"></span></li>
        </ul>
        <?php } ?>

        <?php if ($list_href || $write_href) { ?>
        <ul class="btn_bo_user">
        	 <?php if ($admin_href) { ?><li><span class="jbutton large black"><a href="<?php echo $admin_href ?>" style="background:#b1b4b9">관리자</a></span></li><?php } ?>
            <?php if ($list_href) { ?><li><span class="jbutton large black"><a href="<?php echo $list_href ?>" style="background:#b1b4b9" class="btn_b01">목록</a></span></li><?php } ?>
            <?php if ($write_href) { ?><li><span class="jbutton large black"><a href="<?php echo $write_href ?>" style="background:#b1b4b9" class="width_j">글쓰기</a></span></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>

...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper" class="write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="쿠폰번호">
	...
	<div class="bo_w_info write_div">
	    <label for="wr_1" class="sound_only">등록유무<strong>필수</strong></label>
	    <input type="text" name="wr_1" value="<?php if($write['wr_1']){ echo '등록완료';}else{ echo ''; } ?>" id="wr_1" required class="frm_input full_input required" placeholder="등록됐을 시 '등록완료', 아닐 시 빈칸">
	</div>

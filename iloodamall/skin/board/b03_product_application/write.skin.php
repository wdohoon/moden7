...
<section id="bo_w">
    ...
    <div class="jtbl_frm01 tbl_wrap">
        ...
        <?php } ?>
        <tr>
            <th scope="row"><label for="wr_11">병원명 <span class="req">*</span></label></th>
            <td>
				<input type="text" name="wr_11" value="<?php echo $name ?>" id="wr_11" required class="frm_input" style="max-width: 355px;">
			</td>
        </tr>
		...
		<?php }  ?>
<!-- 		<?php if($bo_table!='genuine'){ ?>
		<tr>
		            <th scope="row"><label for="wr_email">이메일 <span class="req">*</span></label></th>
		            <td><input type="text" name="wr_email" value="<?php echo $email ?>" id="wr_email" required class="frm_input email" style="max-width: 355px;"></td>
		        </tr>
		<?php } ?> -->
		...
		<?php if($bo_table!='genuine'){ ?>
		<tr>
            <th scope="row"><label for="wr_1">문의 종류 <span class="req">*</span></label></th>
            <td class="td_job">
				<span>
					<input type="radio" name="wr_1" value="장비문의" <?php if($wr_1=="장비문의")echo"checked";?> id="job1" required>
					<label for="job1">장비문의</label> &nbsp;&nbsp;
				</span>
				<?php if($bo_table == 'inquiry') { ?>
				<span>
					<input type="radio" name="wr_1" value="회원가입 문의" <?php if($wr_1=="회원가입 문의")echo"checked";?> id="job2" required>
					<label for="job2">회원가입 문의</label> &nbsp;&nbsp;
				</span>
				<?php } ?>
				<?php if($bo_table == 'mb_inquiry') { ?>
				<span>
					<input type="radio" name="wr_1" value="A/S 문의" <?php if($wr_1=="A/S 문의")echo"checked";?> id="job2" required>
					<label for="job2">A/S 문의</label> &nbsp;&nbsp;
				</span>
				<?php } ?>
				<span>
					<input type="radio" name="wr_1" value="쇼핑몰 문의" <?php if($wr_1=="쇼핑몰 문의")echo"checked";?> id="job3" required>
					<label for="job3">쇼핑몰 문의</label> &nbsp;&nbsp;
				</span>
				<span>
					<input type="radio" name="wr_1" value="기타 문의" <?php if($wr_1=="기타 문의")echo"checked";?> id="job4" required>
					<label for="job4">기타 문의</label> &nbsp;&nbsp;
				</span>
			</td>
        </tr>
		<?php }else{ ?>
		<tr>
            ...
            <td><input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input email" style="max-width: 355px;"></td>
        </tr>
		<?php } ?>
		...
		<?php if($bo_table!='genuine'){ ?>
			...
			<tr>
				...
				<td><input type="text" name="wr_2" value="<?php //echo $write['wr_2'] ?>" id="wr_2" required class="frm_input" style="max-width: 355px;"></td>
			</tr>
			<?php } else { ?>
			<tr>
				<th scope="row"><label for="wr_2">연락처 <span class="req">*</span></label></th>
				<td><input type="text" name="wr_2" value="<?php //echo $member['mb_hp'] ?>" id="wr_2" required class="frm_input" style="max-width: 355px;"></td>
			</tr>
			<?php } ?>
		<?php }else{ ?>
			<tr>
				<th scope="row"><label for="wr_2">시리얼넘버 <span class="req">*</span></label></th>
				<td><input type="text" name="wr_2" value="<?php //echo $write['wr_2'] ?>" id="wr_2" required class="frm_input" style="max-width: 355px;"></td>
			</tr>
		<?php } ?>

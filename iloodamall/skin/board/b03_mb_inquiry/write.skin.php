...
<section id="bo_w">
    ...
    <div class="jtbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td><input type="text" name="wr_2" value="<?php echo $member['mb_hp'] ?>" id="wr_2" <?php if($member['mb_level'] != '10') echo 'required';?> class="frm_input" style="max-width: 355px;" readonly></td>
		</tr>

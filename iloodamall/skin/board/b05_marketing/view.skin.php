...
.btn_wrap li{position:relative; float:none !important; margin:0 auto; width: 260px;}

.btn_wrap li a.more_more span{position:absolute; top:55%; right:10%; transform:translate(-50%,-50%);}
...
.btn_wrap li{width: 40%; height: 6vw; line-height: 6vw;}
}
</style>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
 <!--    <header>
	...
	<!-- <tr>
		<td class="write_head" style="">이벤트 기간</td>
...
<!-- 	<tr>
	...
	<!--제품바로가기 버튼-->
	<!-- <ul class="btn_wrap">
		<li class="left"><a href="<?php echo $view['link_href'][1] ?>" class="more_more">다운로드 바로가기<span></span></a></li>
	</ul> -->
         ...
         ?>
            <li>
                <a href="<?php echo $view['link_href'][$i] ?>" target="_blank">
                    ...
                    <strong><?php echo $view['wr_subject'] ?> 다운로드 바로가기</strong>
                </a>

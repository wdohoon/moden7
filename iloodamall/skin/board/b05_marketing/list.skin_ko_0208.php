...
.gall_row .col-gn-3:nth-child(3n){
	...
	.tab_title{width: 100%; justify-content:center; align-items:center; flex-wrap: wrap; }
	.tab_title li {cursor: pointer;width: 16.4063vw;height: 5.2083vw;line-height: 5.2083vw;font-size: 2.2135vw;padding:0 0.5208vw; background: ;}
}
@media (max-width: 480px)  {
	...
	.tab_title{width: 100%;justify-content:center; align-items:center; flex-wrap: wrap;}
	.tab_title li {cursor: pointer;width: 26.2500vw;height: 8.3333vw;line-height: 8.3333vw;font-size: 3.5417vw;padding:0 0.8333vw;}
}
                ...
                <div class="gall_con">
					...
					<div class="event_wrap">
                       ...
                       <!--  <a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></a> -->
						...
						<ul class="btn_wrap">
							<?php
								$sql = " select * from g5_board_file  where bo_table = '{$bo_table}' and wr_id = '{$list[$i]['wr_id']}' and bf_no = '1' order by bf_no desc";
                         ...
                         <?
                           ...
                           ?>                             
							...
							<li class="left center"><a href="/data/file/marketing/<?php echo$rowa['bf_file'] ?>" target="_blank" class="more_more">다운로드</a></li>
							<li class="left center"><a href="/data/file/marketing/<?php echo$rowb['bf_file'] ?>" target="_blank" class="more_more"> 미리보기</a></li>
                            
                            
                            
							<?php } else { ?>
							<li class="left center"><a href="<?php echo $list[$i]['wr_link1'] ?>" target="_blank" class="more_more">다운로드</a></li>
							<li class="left center"><a href="<?php echo $list[$i]['href'] ?>" class="more_more"> 미리보기</a></li>
							<?php } ?>

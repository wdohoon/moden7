...
.reepot_wraps .reepot_coments span{
	font-size: 24px;
}
.reepot_wraps .reepot_coments2 h4{
	margin-top: 90px;
	font-size: 60px;
}
.reepot_wraps .reepot_coments2 span{
	font-size: 50px;
}
...
/* 텍스트 영역 */
.reepot_wrap {padding:130px 0px 160px;display: flex;justify-content:center; align-items:center;     flex-direction: column;}
.reepot_wrap h1{margin-bottom: 130px;}
...
.reepot_wrap h1{margin-bottom: 7.3864vw;}
...
.reepot_wrap h1{margin-bottom:8.1250vw;}
.reepot_wrap:after {clear:both;}
.reepot_wrap .wrapper_inner{ flex-wrap:wrap;}
...
.reepot_wrap h1{margin-bottom:9.2857vw;}
.reepot_wrap:after {clear:both;}
.reepot_wrap .wrapper_inner{ flex-wrap:wrap;}
...
.reepot_wrap h1{margin-bottom:16.9271vw;}
.reepot_wraps .reepot_coments span{
	font-size: 3.1250vw;
}
.reepot_wraps .reepot_coments2 h4{
...
.banner_img{
	background: url(/images/guardians_bg_cm_v3_2.png)no-repeat center top / cover;
}
</style>
<?php
...
<div class="reepot_wrap">
	<h1 style="font-size:60px;color: #b1b4b9;">연자 소개</h1>
	<img src="/skin/board/b03_guardians/img/members.png" alt="">
</div>
<div class="reepot_wraps">
	<div class="reepot_coments">
		<span>
		리팟 시술 10,000 여 케이스, 다양한 경험과 노하우 공유 <br>
		오직 이루다만이 제공하는 특별한 경험  <br>
		리팟으로 가능한 모든 진료를 더 깊게 알아보는 <br>
		핸즈온 라이브 세미나
		</span>
	</div>
	<div class="reepot_coments2">
		<h4>reepot Guardians</h4>
		<span>지금신청하세요</span>
	</div>
</div>

...
<style>
.youtubeWrap { position: relative; height: 0; padding-bottom: 56.25%; }
...
<article id="bo_v" style="max-width: 1200px;margin: 0 auto;">
    <header>
        <h2 id="bo_v_title">
    ...
    <section id="bo_v_atc">
        ...
        <?php 
            ...
            <div class="youtubeWrap">
                <iframe width="100%" height="100%" src="//www.youtube.com/embed/<?php echo $v; ?>?feature=player_detailpage&vq=hd720" frameborder="0" allowfullscreen></iframe>
            </div>
         <?php } ?>
        <!-- } 유튜브 동영상 시작 -->

...
<section id="bo_w" style="max-width: 1200px;margin: 0 auto;">
	...
	※ 유튜브 영상링크
	<span style="color:red;display:block;">※ 실제 유튜브 홈페이지 상단 URL을 복사하셔야 합니다.</span>
	<div class="bo_w_link write_div">		
        <label for="wr_10"><i class="fa fa-youtube-play" aria-hidden="true"></i><span class="sound_only">동영상</span></label>

...
/*  */
.new_cate03 {margin-bottom: 40px;}
.new_cate03 ul {}
.new_cate03 ul:after {content:"";display:block;clear:both;}
.new_cate03 ul li {float:left;width:150px;height: 54px;line-height:54px;text-align: center;margin:0 5px;}
.new_cate03 ul li a {display:block;border:1px solid #d5d5d5;font-size: 14px;font-weight: 400;}
.new_cate03 ul li a#bo_cate_on {border-color:#000;font-weight: 500;}

@media (max-width:1760px){
/*  */
.new_cate03 {margin-bottom: 2.2727vw;}
.new_cate03 ul {}
.new_cate03 ul:after {clear:both;}
.new_cate03 ul li {width:8.5227vw;height: 3.0682vw;line-height:3.0682vw;margin:0 0.2841vw;}
.new_cate03 ul li a {border:0.0568vw solid #d5d5d5;font-size: 0.7955vw;}
}

@media (max-width:1600px){
/*  */
.new_cate03 {margin-bottom: 2.5000vw;}
.new_cate03 ul {}
.new_cate03 ul:after {clear:both;}
.new_cate03 ul li {width:9.3750vw;height: 3.3750vw;line-height:3.3750vw;margin:0 0.3125vw;}
.new_cate03 ul li a {border:0.0625vw solid #d5d5d5;font-size: 0.8750vw;}
}

@media (max-width:1400px){
/*  */
.new_cate03 {margin-bottom: 2.8571vw;}
.new_cate03 ul {}
.new_cate03 ul:after {clear:both;}
.new_cate03 ul li {width:10.7143vw;height: 3.8571vw;line-height:3.8571vw;margin:0 0.3571vw;}
.new_cate03 ul li a {border:0.0714vw solid #d5d5d5;font-size: 1.0000vw;}
}

@media (max-width:1024px){
/*  */
.new_cate03 {margin-bottom: 3.9063vw;}
.new_cate03 ul {}
.new_cate03 ul:after {clear:both;}
.new_cate03 ul li {width:14.6484vw;height: 5.2734vw;line-height:5.2734vw;margin:0 0.4883vw;margin-bottom:0.9766vw;}
.new_cate03 ul li a {border:0.0977vw solid #d5d5d5;font-size: 1.3672vw;}
}

@media (max-width:768px){
/*  */
.new_cate03 {margin-bottom: 5.2083vw;}
.new_cate03 ul {}
.new_cate03 ul:after {clear:both;}
.new_cate03 ul li {width:19.5313vw;height: 7.0313vw;line-height:7.0313vw;margin:0 0.6510vw;margin-bottom:1.3021vw;}
.new_cate03 ul li a {border:0.1302vw solid #d5d5d5;font-size: 1.8229vw;}
}

@media (max-width:480px){
/*  */
.new_cate03 {margin-bottom: 8.3333vw;}
.new_cate03 ul {}
.new_cate03 ul:after {clear:both;}
.new_cate03 ul li {width:49%;height: 11.2500vw;line-height:11.2500vw;margin:0;margin-right:2%;margin-bottom:2.0833vw;}
.new_cate03 ul li:nth-child(2n){margin-right: 0;}
.new_cate03 ul li a {border:0.2083vw solid #d5d5d5;font-size: 2.9167vw;}
}
...
<div class="faq">
	...
	<li class="article hide">
		<p class="q <? if ($i == 0 ) echo "first";?>">
			<a href="#a<?=$list[$i][num]?>" class="trigger">
				<?php if ($is_category && $list[$i]['ca_name']) {	?>
					[
					<?  $category = explode('_', $list[$i]['ca_name']);
        ...
        <? if (($member['mb_id'] && ($member['mb_id'] == $write['mb_id'])) || $is_admin) { ?>
			...
			<a class="my_btn01" href="/bbs/delete.php?bo_table=<?=$bo_table?>&wr_id=<?=$list[$i]['wr_id']?>&page=&token=<?=$token?>">
			삭제</a>
		 <? } ?>

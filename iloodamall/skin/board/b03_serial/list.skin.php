...
<?php if ($is_admin){?>
	<!-- <div class="excelbtn">
		<a href="./boardexcel.php" onclick="return excelform(this.href);" target="_blank" class="btn btn_02">게시글일괄등록</a>
	</div> -->
<?php } ?>


    <form name="fboardlist" id="fboardlist" action="./board_list_update6.php" onsubmit="return fboardlist_submit(this);" method="post">
    <input type="hidden" name="bo_table" value="<?php echo $bo_table ?>">
    ...
    <div class="tbl_head03 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col">NO</th>
            <th scope="col" class="th02">시리얼넘버</th>
			<th scope="col" class="th01 pcc">제품명</th>
			<th scope="col" class="th03 pcc">출고일자</th>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
			...
			<td class="td_subject sv_use pcc"><div class="bo_tit"><a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['wr_1'] ?></a></div></td>
			<td class="td_name sv_use pcc"><?php echo $list[$i]['wr_subject'] ?></td>
...
function fboardlist_submit(f) {
    ...
    if(document.pressed == "선택삭제") {
        ...
        f.action = "./board_list_update6.php";
    }

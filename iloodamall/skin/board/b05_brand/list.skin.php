            ...
            <div class="gall_box">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_img">
                        ...
                        <?php } else {
                            $thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], $board['bo_gallery_width'], $board['bo_gallery_height'], false, true, 'center', false, '80/0.5/3');
					...
					<div class="event_wrap">
						...
						<!-- <a href="/bbs/download.php?bo_table=<?=$bo_table?>&wr_id=<?=$list[$i]['wr_id']?>&no=1" class="down_icon">다운로드</a> -->

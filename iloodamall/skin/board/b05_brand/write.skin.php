...
<section id="bo_w" style="background:#fff;">
  ...
  <!--       <tr>
       ...
       <!--  <tr>
		...
		<tr>
            <th scope="row"><label for="wr_1">브랜드 명</label></th>
			<td>
				<input style="width:35%;min-width:180px;;" type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input"  maxlength="255">
			</td>
        </tr>

		...
		<tr>
            ...
            <td><!-- <input type="text" name="wr_16" value="" id="wr_16"  class="frm_input half_input"> -->
				<select name="wr_3" id="wr_3" class="frm_input half_input">
					...
					<option value="Male" <?php if($write['wr_3']=='Male') echo 'selected'; ?>>남</option>
					<option value="Female" <?php if($write['wr_3']=='Female') echo 'selected'; ?>>여</option>
				</select>
			</td>
		</tr>
		<tr>
        ...
        <tr>
            ...
            <td>
				<div class="filebox filebox<?php echo $i+1 ?> preview-image"> 
					<input class="upload-name<?php echo $i+1 ?>" value="파일선택" disabled="disabled" > 
					<label for="input-file<?php echo $i+1 ?>">업로드</label> 
					<input type="file" name="bf_file[]" id="input-file<?php echo $i+1 ?>" class="upload-hidden<?php echo $i+1 ?>"> 
				</div>

                <!-- <input type="file" name="bf_file[]" title="파일첨부 <?php echo $i+1 ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="frm_file frm_input"> -->
                
				<div class="file_thumb file_thumb<?php echo $i+1 ?>" style="width: 100px;">
                <?php if($w == 'u' && $file[$i]['file']) { ?>	
				<img src="<?php echo $file[$i]['path'].'/'.$file[$i]['file']?>" alt="" style="width: 100%;">
                <input type="checkbox" id="bf_file_del<?php echo $i ?>" name="bf_file_del[<?php echo $i;  ?>]" value="1"> <a href="javascript:;" onclick="aa('bf_file_del<?php echo $i ?>');"> 파일 삭제</label>
                <?php } else { ?>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<input type="text" id="wr_17" name="wr_17" placeholder="입력해주세요." class="frm_input other_wrap half_wrap" value="<?php echo $wr_17; ?>"/>
					</td>
				</tr>
				<tr>
					<th scope="row" class=""><label for="wr_18" class="">회원번호(선택)<strong class="sound_only">필수</strong></label></th>

					<td><input type="text" name="wr_18" value="<?php echo $wr_18 ?>" id="wr_18" class="frm_input half_input" size="10" maxlength="20" placeholder="영문, 숫자만 입력해주세요"></td>
				</tr>
			</tbody>
		</table>
	</div>

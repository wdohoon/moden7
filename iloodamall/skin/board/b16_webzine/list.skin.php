            ...
            <div class="gall_box">
				...
				<div class="gall_img" >
					...
					if($thumb['src']) {
						...
						$img_content = '<img src="/shop/img/no_image.gif" alt="no-image" width="'.$board['bo_gallery_width'].'" height="'.$board['bo_gallery_height'].'">';
					}
				...
				<div class="gall_text_href" style="height:<?php echo $board['bo_gallery_height']?>px;">
					<?php
					...
					<a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
					 ...
					 <a href="<?php echo $list[$i]['href'] ?>"><?php echo cut_str(strip_tags($list[$i]['wr_content']), 150, '...')?></a>
					 </div>
					 <div class="bo_info">
					 <span>작성일</span> <?php echo date("Y.m.d", strtotime($list[$i]['wr_datetime'])) ?> <small>｜</small>
					 <span>작성자</span> <?php echo $list[$i]['name'] ?> <small>｜</small>
					 <span>조회수</span> <?php echo $list[$i]['wr_hit'] ?>
					 </div>
				</div>
            </div>
        </li>

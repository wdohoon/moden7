...
<section id="bo_w">
    ...
    <div class="jtbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
				<input type="text" name="wr_name" value="<?php echo $member['mb_name'] ?>" id="wr_name" required class="frm_input" style="max-width: 355px;">
			</td>
        </tr>
...
<div class="write_btn_div">
    ...
    <?php } ?>
    <input type="submit" value="작성완료" id="btn_submit" accesskey="s" class="btn_submit btn" style="background:#b1b4b9 !important" onclick="showAlert()">
    <script>
        function showAlert() {
            <?php if ($is_member) { ?>
                alert('답변은 마이페이지에서 확인 가능합니다');
            <?php } else { ?>
                alert('문의 완료');
            <?php } ?>
        }

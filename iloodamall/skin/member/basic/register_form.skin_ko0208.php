...
gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
                ...
                정품등록
               	...
               	<select name="input1" placeholder="제품을 선택하세요.">
									<option value="reepot" selected>reepot</option>
	...
	<div class="btn_confirm">
		<?php if($w==''){ ?>
	    <button type="submit" id="btn_submit" class="btn_close" accesskey="s" name="action" value="survey" style="background:#333; color:#fff;">설문조사 하기</button>

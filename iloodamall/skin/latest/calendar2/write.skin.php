...
<link rel="stylesheet" href="<?php echo $board_skin_url ?>/spectrum/spectrum.css">
<script src="<?php echo $board_skin_url ?>/spectrum/spectrum.js"></script>

<style>
.tbl_frm01 th { width: 130px; }
.s_wrap{margin-top: 100px;margin-bottom:100px}
</style>

<section id="bo_w" class="s_wrap">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="wr_5">배경색상</label></th>
            <td><input type="text" name="wr_5" value="<?php echo $wr_5 ?>" id="wr_5" class="frm_input" size="50"></td>
        </tr>

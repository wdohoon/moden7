...
<!-- 게시물 읽기 시작 { -->
<div id="bo_v_table" style="display: none;"><?php echo $board['bo_subject']; ?></div>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h1 id="bo_v_title">
			...
			echo " (".substr($view['wr_13'],4,2)."/".substr($view['wr_13'],6,2)." ~ ".substr($view['wr_13'],4,2)."/".substr($view['wr_13'],6,2).")";
            ?>
        </h1>
    </header>

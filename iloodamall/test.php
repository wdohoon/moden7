        ...
        <table>
            ...
            <thead>
                <tr>
					...
					<th scope="col" rowspan="2" id="mb_list_group4" style="width:30%">정품등록제품</th>

                    <th scope="col" id="mb_list_auth" style="width:10%">상태</th>
                    <th scope="col" id="mb_list_mobile">휴대폰</th>
                    <th scope="col" id="mb_list_lastcall"><?php echo subject_sort_link('mb_today_login', '', 'desc') ?>최종접속</a></th>
                    <th scope="col" id="mb_list_grp" style="width: 100px;">적립금</th>
                ...
                ?>
                    ...
                    <tr class="<?php echo $bg; ?>">
						...
						<td headers="mb_list_group4" rowspan="2">
							<?php 
								$genuine = sql_fetch(" select * from g5_write_genuine where mb_id = '{$row['mb_id']}' ");
								echo $genuine['wr_1'];
							?>
						</td>

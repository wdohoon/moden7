                ...
                <tr>
                    ...
                    <td>
                        ...
                        if($pp['pp_settle_case'] == '휴대폰')
                        {
                            ...
                            } else if($pp['pp_pg'] == 'nicepay') { // acefive
                        ...
                        if($pp['pp_settle_case'] == '신용카드')
                        {
                            if($pp['pp_pg'] == 'lg') {
                                ...
                                $card_receipt_script = 'window.open(\'https://npg.nicepay.co.kr/issue/IssueLoader.do?TID='.$pp['pp_tno'].'&type=0\', \'popupIssue\', \'toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes, resizable=yes,width=420,height=540\');';
                            } else {
                ...
                <tr>
                    ...
                    if ($pp['pp_cash'])
                    {
                        if($pp['pp_pg'] == 'lg') {
                            ...
                            $cash_receipt_script = 'window.open(\'https://npg.nicepay.co.kr/issue/IssueLoader.do?TID='.$pp['pp_cash_no'].'&type=1\', \'popupIssue\', \'toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,width=414,height=622\');';
                        } else {

...
<div class="index_container">
	...
	<div class="goods">
		<a href="/shop/list.php?ca_id=10">상품 보러가기</a>
	</div>
...
<div class="cx_center">
	...
	<form action="/bbs/write_update2.php" method="post">
		<div class="inquiry">
			<h4>빠른 문의</h4>
			<div class="input_box">
				<input type="text" value="빠른 문의"  name="wr_subject" style="display: none;" >
				<input type="text" placeholder="성함" name="wr_name">
				<input type="text" placeholder="연락처" name="wr_1">
				<textarea name="wr_content" id="" placeholder="문의내용"></textarea>

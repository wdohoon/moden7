...
define('G5_MYSQL_HOST', 'db.moden2432.gabia.io');
define('G5_MYSQL_USER', 'moden2432');
define('G5_MYSQL_PASSWORD', '2580ac2580!');
define('G5_MYSQL_DB', 'dbmoden2432');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', 'd3dd06db6b6235d58c38688b7bc2b918'); // 토큰 암호화에 사용할 키

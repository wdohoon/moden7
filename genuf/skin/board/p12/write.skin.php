...
<section id="bo_w">
    ...
    <div class="jtbl_frm01 tbl_wrap">
		...
		<tr>
			<th scope="row"><label for="wr_1">시작일자</label></th>
            <td><input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input" maxlength="100"></td>
		</tr>
		<tr>
			<th scope="row"><label for="wr_2">종료일자</label></th>
            <td><input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input" maxlength="100"></td>
		</tr>
        <tr>
    ...
    <script>
	$("#wr_1, #wr_2").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yy-mm-dd", showButtonPanel: true, yearRange: "c-99:c+99", maxDate: "+0d" });

...
#bo_gall .gall_con > li {float:left;}
...
<!-- 게시판 목록 시작 { -->
<div id="bo_gall" style="width:1280px;margin:0 auto;padding:300px 0;">
    <?php if ($is_category) { ?>
    <nav id="bo_cate">
    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:<?php echo $board['bo_gallery_width'] ?>px">
            ...
            <ul class="gall_con clearfix" style="width:<?=$board['bo_gallery_width']?>px;">
                <li class="gall_href">
                ...
                <li class="g_date"><?php echo $list[$i]['wr_1'] ?> ~ <?php echo $list[$i]['wr_2'] ?></li>

...
<section id="bo_w">
    ...
    <div class="jtbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
			<input type="password" name="wr_password" id="wr_password" <?php echo $password_required ?> class="frm_input" maxlength="20" autocomplete="new-password">
			</td>
        </tr>
        <?php } ?>
...
<!-- 		<tr>
		            <th scope="row"><label for="wr_1">강의명</label></th>
		            <td><input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input" size="50"></td>
		        </tr>
		
		<tr>
		            <th scope="row"><label for="wr_2">강사명</label></th>
		            <td><input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input" size="50"></td>
		        </tr>
		
		<tr>
		            <th scope="row"><label for="wr_3">경력</label></th>
		            <td>
			<textarea name="wr_3" id="wr_3" style="width: 100%;height:150px;" ><?php echo $wr_3 ?></textarea>
			</td>
		        </tr> -->

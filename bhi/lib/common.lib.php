...
function get_paging($write_pages, $cur_page, $total_page, $url, $add="")
{
    ...
    $str = "<div class='page'>";
    if ($cur_page >= 1) {
		$str .= "<a href='" . $url . ($cur_page-1) . "{$add}' class='btn prev'>&lt;</a>";
	...
	$str .= "<span>".$cur_page." / ".$total_page."</span>";

    if ($cur_page < $total_page) {
        //$str .= "[<a href='$url" . ($cur_page+1) . "'>다음</a>]";
		$str .= " <a href='" . $url . ($cur_page+1) . "{$add}' class='btn next'>&gt;</a>";
    }else if ($cur_page = $total_page) {
        //$str .= "[<a href='$url" . ($cur_page+1) . "'>다음</a>]";
		$str .= " <a href='" . $url . ($cur_page) . "{$add}' class='btn next'>&gt;</a>";
    }
    $str .= "</div>";

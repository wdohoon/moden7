...
//$kkss= sql_fetch("select * from g5_member where mb_id='admin'");
//print_r($kkss);
//sql_query("update g5_member set mb_level=10 where mb_id='admin'");
?>
...
<section id="anc_cf_join">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="3">
			<!-- <textarea name="cf_stipulation" id="cf_stipulation" rows="10"><?php echo html_purifier($config['cf_stipulation']); ?></textarea> -->
			<?php echo editor_html('cf_stipulation', get_text(html_purifier($config['cf_stipulation']), 0)); ?>
			</td>
        </tr>
        <tr>
            <th scope="row"><label for="cf_privacy">개인정보처리방침</label></th>
            <td colspan="3"><!-- <textarea id="cf_privacy" name="cf_privacy" rows="10"><?php echo html_purifier($config['cf_privacy']); ?></textarea> -->
			<?php echo editor_html('cf_privacy', get_text(html_purifier($config['cf_privacy']), 0)); ?>
			</td>
        </tr>
        </tbody>
        </table>

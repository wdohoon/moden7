...
$ethBalance = getEthereumBalance($ethAddr, $apiKey); // 관리자의 이더리움 잔액 가져오기 함수 호출
...
<section id="point_mng">
    <h2 class="h2_frm">회원 ETH 설정</h2>
    <h1>관리자 보유 ETH <?php echo number_format($ethBalance, 4);?> <span>ETH</span></h1>
    <form name="fpointlist2" method="post" id="fpointlist2" action="./insert_eth_update.php" autocomplete="off">

...
document.addEventListener("DOMContentLoaded", function() {
    const mbIdInput = document.getElementById("mb_id");
    const form = document.querySelector("form");

    mbIdInput.addEventListener("input", function() {
        if (mbIdInput.value.toLowerCase() === "admin") {
            alert("회원아이디에 'admin'을 입력할 수 없습니다.");
            mbIdInput.value = "";
            mbIdInput.focus();
        }
    });

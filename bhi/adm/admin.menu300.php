...
$menu['menu300'] = array (
    ...
    //array('300001', '배너', '/bbs/board.php?bo_table=banner1', 'board'),
	//array('300002', '쇼핑몰배너', '/bbs/board.php?bo_table=banner2', 'board'),
	array('300100', '게시판관리', ''.G5_ADMIN_URL.'/board_list.php', 'bbs_board'),
	array('300900', 'G-POINT 구매',  '/bbs/board.php?bo_table=b08', 'bbs_board'),
	array('300910', 'G-POINT 판매',  '/bbs/board.php?bo_table=sell', 'bbs_board'),
	array('300920', 'G-POINT 스왑',  '/bbs/board.php?bo_table=swap', 'bbs_board'),

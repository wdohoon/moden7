...
if ($bo_table == 'inquiry') {
    include_once(G5_LIB_PATH.'/mailer.lib.php');
    $subject = '['.$config['cf_title'].'] 문의가 접수되었습니다.';
    $content = '<p>새로운 문의가 접수되었습니다.</p>';
    $wr_name = isset($wr_name) ? $wr_name : '비회원';
    $wr_email = isset($wr_email) ? $wr_email : 'no-reply@example.com'; // 기본 이메일 주소 설정

    mailer($wr_name, $wr_email, 'moden7@naver.com', $subject, $content, 1);
}

...
<div id="bo_list">
    ...
    <form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
        ...
        <div class="jtbl_head01 jtbl_wrap">
			<div class="as">
				<a href="/bbs/board.php?bo_table=b08" style="font-weight:bold;font-size:1.2rem;">구매</a>
            ...
            <tr>
                ...
                <th scope="col" class="hide_mo ">보낸이</th>
            ...
            <tbody>
            <?php
            // wr_num으로 내림차순 정렬하여 게시물 가져오기
            $result = sql_query("SELECT * FROM g5_write_b08 WHERE wr_is_comment = 0 ORDER BY wr_num DESC");

            for ($i = 0; $row = sql_fetch_array($result); $i++) {
                $list[$i] = $row;
                $list[$i]['href'] = './board.php?bo_table='.$bo_table.'&wr_id='.$row['wr_id'];
                $list[$i]['subject'] = conv_subject($row['wr_subject'], 100);
            }

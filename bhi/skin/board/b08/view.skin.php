...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td class="write_head">입금 아이디</td>
                <td class="write_body"><?php echo $view['mb_id'] ?></td>
            </tr>
            <tr>
                <td class="write_head">코인 종류</td>
                <td class="write_body"><?php echo $view['wr_1'] ?></td>
            </tr>
            <tr>
                <td class="write_head">현재 잔고</td>
                <td class="write_body"><?php echo number_format($view['wr_2'], 4) ?></td>
            </tr>
            <tr>
                <td class="write_head">코인 이름</td>
                <td class="write_body"><?php echo $view['wr_3'] ?></td>
            </tr>
            <tr>
                <td class="write_head">구매 수량</td>
                <td class="write_body"><?php echo number_format($view['wr_4'], 4) ?></td>
            </tr>
            <tr>
                <td class="write_head">구매한 G-POINT 수량</td>
                <td class="write_body"><?php echo number_format($view['wr_5'], 4) ?> G-POINT</td>
            </tr>
        </table>
    </section>

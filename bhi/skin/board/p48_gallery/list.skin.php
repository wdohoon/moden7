   ...
   <!-- <div class="bo_fx">
    ...
    <ul id="gall_ul">
        <?php for ($i=0; $i<count($list); $i++) {
         ...
         ?>
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:50%">
            <?php if ($is_checkbox) { ?>
            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href" style="border-bottom-right-radius:10px; border-bottom-left-radius:10px;">
                    <?php
                    ...
                    <?php// } ?>
                    <a href="<?php echo $list[$i]['href'] ?>">
                        <p class="gall_text01"><?php echo $list[$i]['subject'] ?></p>
                        <p class="gall_text02"><?php echo cut_str($list[$i]['wr_datetime'], 10, ''); ?></p>
                        <p class="gall_text03"><?php echo $list[$i]['wr_name'] ?></p>
               ...
               <!--  <li>
                					<div class="gall_info01">
                					<span class="gall_subject this_left"><img src="/images/date_img01.jpg" alt=""> <?php echo $list[$i]['datetime'] ?></span>
                					<span class="gall_subject this_right"><img src="/images/hit_img01.jpg" alt=""><?php echo $list[$i]['wr_hit'] ?></span>
                					</div>
                				</li> -->
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><span class="jbutton large black"><a href="<?php echo $write_href ?>" class="">글쓰기</a></span></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>

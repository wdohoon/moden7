...
<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
    ...
    <div class="jtbl_head01 jtbl_wrap">
		<div class="as">
			...
			<a href="/bbs/board.php?bo_table=sell" style="font-weight:bold;font-size:1.2rem;">판매</a>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>">
                    <?php echo $list[$i]['wr_1']?>, <?php echo $list[$i]['wr_2']?>, <?php echo $list[$i]['wr_3']?>, <?php echo $list[$i]['wr_4']?>
            ...
            <td class="td_date "><?php echo date('Y-m-d', strtotime($list[$i]['datetime'])); ?></td>

...
include_once(G5_PATH.'/country.php')
?>
<style>
#bo_v_con, #bo_v_img a.view_image{
	text-align:center;
}
</style>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <span class="sound_only">작성자</span> <strong><?php echo $view['name'] ?>(<?php echo $view['mb_id']; ?>)</strong>
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_con">
		<?php 
			$code = $view['wr_content'];
			$nation_name = $arr_nation_code[$code][1];
		?>

		국가 : <?php echo $nation_name; ?><br>
		이름 : <?php echo $view['wr_2'].' '.$view['wr_3']; ?><br>
		신분증 유형 : <?php echo $view['wr_4']; ?><br>
		신분증 번호 : <?php echo $view['wr_5']; ?><br>
		생년월일 : <?php echo $view['wr_6'].'-'.$view['wr_7'].'-'.$view['wr_8']; ?><br>
		
		<?php if($is_admin && $view['wr_10'] == ''){?>
			<a href="/admin_pass.php?wr_id=<?php echo $view['wr_id']?>" class="pass_btn btn1 block f15">승인하기</a>
		<?php } else if($view['wr_10'] == '1'){ ?>
			<span class="pass_btn btn1 block f15"> 승인 완료 </span>	
		<?php }?>

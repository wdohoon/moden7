...
.inner{background:#fff;height: 750px;border-radius:16px;padding: 50px 24px;}
...
.radio label{font-size: 16px;font-weight: 600;line-height: 24px;letter-spacing: -0.025em;text-align: left;color:#111111;padding-bottom:8px;margin-right:5px;}
	...
	<div class="board-write">
		...
		<div class="inner">
			...
			<div class="mb10">
				...
				<input type="hidden" class="inp1 block" name="wr_subject" value="이체 문의">
			...
			<div class="radio">
				<label for="">계좌 이체</label>
				<input type="radio" name="wr_2" value="계좌 이체" <?php echo $type == '계좌이체' ? 'checked' : ''; ?>>
				<label for="">가상 자산 이체</label>
				<input type="radio" name="wr_2" value="가상 자산 이체" <?php echo $type == '가상자산이체' ? 'checked' : ''; ?>>
				<label for="">기타 이체</label>
				<input type="radio" name="wr_2" value="기타 이체" <?php echo $type == '기타이체' ? 'checked' : ''; ?>>
			</div>
